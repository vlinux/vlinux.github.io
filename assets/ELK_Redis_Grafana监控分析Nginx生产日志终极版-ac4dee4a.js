...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),q=s("p",null,"#不知道怎么替换的可以查百度,如果您用的是虚拟主机,请在虚拟主机conf文件中配置引用你主配置文件的log输入定义.",-1),R=s("p",null,"虚拟主机配置文件修改log输入写法如下#如果您没有虚拟主机请跳过这一步",-1),j=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"access_log  /var/log/nginx/access.log main ;")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),S=s("p",null,"配置完成后启动Nginx.",-1),B=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"systemctl start nginx")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),O=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"curl 127.0.0.1")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),P={id:"redis",tabindex:"-1"},M=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"yum -y install redis")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),U=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"cat /etc/redis.conf")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),I=s("p",null,"启动redis",-1),T=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"systemctl start redis")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),V={id:"安装elk",tabindex:"-1"},Y=s("p",null,"ELK的安装前提是需要java环境的,这里图省事,直接用yum安装java",-1),F=s("p",null,"安装java",-1),J=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"yum -y install java")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Z=s("p",null,"验证java",-1),Q=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"java -version")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),W={id:"elk版本需要统一不然会出大问题-这里统一采用最新版7-9-1",tabindex:"-1"},H={id:"安装es-elasticsearch",tabindex:"-1"},X=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@master1 opt]# ls")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ss=s("p",null,"不要着急启动,先修改配置文件",-1),ls=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'[root@master1 opt]# cat /etc/elasticsearch/elasticsearch.yml | grep -v "^$" | grep -v "^#"')]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),as=s("p",null,"由于我们配置了锁定内存所以在系统文件里也要有相应的配置",-1),ns=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"官方解决方案")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),es=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"vim /usr/lib/systemd/system/elasticsearch.service")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),os=s("p",null,"保存后重载系统配置,启动ES",-1),ts=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"systemctl daemon-reload")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"systemctl restart elasticsearch")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),is=s("p",null,"检测ES",-1),cs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"检测端口是否开启")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ps={id:"安装filebeat",tabindex:"-1"},rs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@master1 opt]# rpm -ivh filebeat-7.9.1-x86_64.rpm")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Cs=s("p",null,"配置文件修改",-1),As=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@QLaliyun ~]# cat /etc/filebeat/filebeat.yml")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ds=s("p",null,"启动filebeat",-1),hs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"systemctl start filebeat")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ys={id:"安装logstash",tabindex:"-1"},gs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@master1 opt]# rpm -ivh logstash-7.9.1.rpm ")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),us=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@master1 ~]# cat /etc/logstash/conf.d/yh_nginx_redis.conf")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ms=s("p",null,"启动logstash",-1),_s=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"nohup /usr/share/logstash/bin/logstash -f /etc/logstash/conf.d/yh_nginx_redis.conf &")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ds={id:"安装grafana",tabindex:"-1"},fs=s("p",null,"推荐使用7.0以下版本,否则可能会和部分插件不兼容,这里用的是6.3.2",-1),vs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@master1 opt]# rpm -ivh grafana-7.0.1-1.x86_64.rpm")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),bs=s("p",null,"由于我们后期会用到某些插件所以在这里提前安装",-1),ks=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"grafana-cli plugins install grafana-piechart-panel")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"grafana-cli plugins install grafana-world-map")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),xs=s("p",null,"国内服务器可能安装不上,那就自己想办法好吧",-1),ws=s("p",null,"由于某些不可抗力因素如果后期在模板导入后出现地图图片不能正常显示的原因可以.采用以下做法",-1),$s=s("p",null,"好的我们直接打开Grafana奥里给",-1),Ls=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"systemctl start grafana-server")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Es={id:"配置数据源",tabindex:"-1"},Ns=s("p",null,[s("img",{src:"https://vlinux-1259060227.cos.ap-shanghai.myqcloud.com/www-vlinux-cn-blog-img/gitee-backup/img-master/image/image-20201013131436778.png",alt:"image-20201013131436778"})],-1),Gs=s("p",null,"点击Save&test测试成功后Back",-1),Ks=s("p",null,"导入监控模板",-1),zs=s("p",null,[s("img",{src:"https://vlinux-1259060227.cos.ap-shanghai.myqcloud.com/www-vlinux-cn-blog-img/gitee-backup/img-master/image/image-20201013131610205.png",alt:"image-20201013131610205"})],-1),qs=s("p",null,[s("img",{src:"https://vlinux-1259060227.cos.ap-shanghai.myqcloud.com/www-vlinux-cn-blog-img/gitee-backup/img-master/image/image-20201013131647199.png",alt:"image-20201013131647199"})],-1),Rs=s("p",null,[s("img",{src:"https://vlinux-1259060227.cos.ap-shanghai.myqcloud.com/www-vlinux-cn-blog-img/gitee-backup/img-master/image/image-20201013131729032.png",alt:"image-20201013131729032"})],-1),js=s("p",null,[l("下面直接出图"),s("img",{src:"https://vlinux-1259060227.cos.ap-shanghai.myqcloud.com/www-vlinux-cn-blog-img/gitee-backup/img-master/image/123.png",alt:"123"})],-1),Ss=s("p",null,[s("img",{src:"https://vlinux-1259060227.cos.ap-shanghai.myqcloud.com/www-vlinux-cn-blog-img/gitee-backup/img-master/image/456.png",alt:"456"})],-1);function Bs(o,Os,Ps,Ms,c,Us){const n=h,p=r;return d(),A(p,{frontmatter:c.frontmatter,data:c.data},{"main-content-md":a(()=>[s("h2",u,[l("先上架构图 "),e(n,{class:"header-anchor",href:"#先上架构图","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),m,_,s("h2",D,[l("简单介绍下Grafana "),e(n,{class:"header-anchor",href:"#简单介绍下grafana","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),s("blockquote",null,[s("p",null,[l("grafana 是一款采用 go 语言编写的开源应用，主要用于大规模指标数据的可视化展现，是网络架构和应用分析中最流行的时序数据展示工具，目前已经支持绝大部分常用的时序数据库,官网（"),e(n,{href:"http://docs.grafana.org/%EF%BC%89",target:"_blank",rel:"noreferrer"},{default:a(()=>[l("http://docs.grafana.org/）")]),_:1}),l(".")])]),s("h2",f,[l("监控指标 "),e(n,{class:"header-anchor",href:"#监控指标","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),v,b,s("h2",k,[l("开始部署 "),e(n,{class:"header-anchor",href:"#开始部署","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),s("h3",x,[l("Nginx "),e(n,{class:"header-anchor",href:"#nginx","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),w,$,L,E,N,G,K,z,q,R,j,S,B,O,s("h2",P,[l("Redis "),e(n,{class:"header-anchor",href:"#redis","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),M,U,I,T,s("h2",V,[l("安装ELK "),e(n,{class:"header-anchor",href:"#安装elk","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),Y,F,J,Z,Q,s("h3",W,[l("ELK版本需要统一不然会出大问题,这里统一采用最新版7.9.1 "),e(n,{class:"header-anchor",href:"#elk版本需要统一不然会出大问题-这里统一采用最新版7-9-1","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),s("h4",H,[l("安装ES(elasticsearch) "),e(n,{class:"header-anchor",href:"#安装es-elasticsearch","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),X,ss,ls,as,ns,es,os,ts,is,cs,s("h4",ps,[l("安装filebeat "),e(n,{class:"header-anchor",href:"#安装filebeat","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),rs,Cs,As,ds,hs,s("h4",ys,[l("安装logstash "),e(n,{class:"header-anchor",href:"#安装logstash","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),gs,s("p",null,[l('修改logstash配置文件,后期用nohup方式启动,不知道的话不用关心 跟着操作就行，注意下载世界IP库文件 [file href="'),e(n,{href:"https://wwe.lanzous.com/i0a1Amdjezi",target:"_blank",rel:"noreferrer"},{default:a(()=>[l("https://wwe.lanzous.com/i0a1Amdjezi")]),_:1}),l('"]GeoLite2-City.mmdb[/file]')]),us,ms,_s,s("h4",Ds,[l("安装Grafana "),e(n,{class:"header-anchor",href:"#安装grafana","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),fs,vs,bs,ks,xs,ws,s("p",null,[l("参考博客:"),e(n,{href:"https://www.cnblogs.com/xuewenlong/p/12929443.html",target:"_blank",rel:"noreferrer"},{default:a(()=>[l("https://www.cnblogs.com/xuewenlong/p/12929443.html")]),_:1})]),$s,Ls,s("h5",Es,[l("配置数据源 "),e(n,{class:"header-anchor",href:"#配置数据源","aria-hidden":"true"},{default:a(()=>[l("#")]),_:1})]),Ns,Gs,Ks,zs,qs,Rs,js,Ss]),"main-header":a(()=>[t(o.$slots,"main-header")]),"main-header-after":a(()=>[t(o.$slots,"main-header-after")]),"main-nav":a(()=>[t(o.$slots,"main-nav")]),"main-content":a(()=>[t(o.$slots,"main-content")]),"main-content-after":a(()=>[t(o.$slots,"main-content-after")]),"main-nav-before":a(()=>[t(o.$slots,"main-nav-before")]),"main-nav-after":a(()=>[t(o.$slots,"main-nav-after")]),comment:a(()=>[t(o.$slots,"comment")]),footer:a(()=>[t(o.$slots,"footer")]),aside:a(()=>[t(o.$slots,"aside")]),"aside-custom":a(()=>[t(o.$slots,"aside-custom")]),default:a(()=>[t(o.$slots,"default")]),_:3},8,["frontmatter","data"])}const Zs=C(g,[["render",Bs]]);export{Js as __pageData,Zs as default};
