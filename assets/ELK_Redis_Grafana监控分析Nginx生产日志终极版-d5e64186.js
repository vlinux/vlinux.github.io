...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),M=s("p",null,"启动redis",-1),U=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",null,[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"systemctl start redis")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),I=s("h2",{id:"安装elk",tabindex:"-1"},[l("安装ELK "),s("a",{class:"header-anchor",href:"#安装elk","aria-hidden":"true"},"#")],-1),T=s("p",null,"ELK的安装前提是需要java环境的,这里图省事,直接用yum安装java",-1),Y=s("p",null,"安装java",-1),F=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",null,[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"yum -y install java")]),l(`
