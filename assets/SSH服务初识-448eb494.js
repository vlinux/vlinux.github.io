import{_ as r}from"./ValaxyMain.vue_vue_type_style_index_0_lang-d46a0622.js";import{_ as c,c as _,w as n,o as u,b as s,U as e,q as o,a as p,r as a,W as f,p as m}from"./app-f99ffcec.js";import"./YunFooter.vue_vue_type_script_setup_true_lang-b7d30a4f.js";import"./YunCard.vue_vue_type_style_index_0_lang-3d84b3a3.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang-95246a82.js";const Ls=JSON.parse('{"title":"SSH服务初识","description":"","frontmatter":{"title":"SSH服务初识","categories":"Linux技术","tags":["SSH"],"date":"2018-09-08T16:38:00.000Z"},"headers":[{"level":2,"title":"1.管理端服务器","slug":"_1-管理端服务器","link":"#_1-管理端服务器","children":[]},{"level":2,"title":"2.被管理端服务器","slug":"_2-被管理端服务器","link":"#_2-被管理端服务器","children":[]},{"level":2,"title":"1.解决免交互问题：","slug":"_1-解决免交互问题：","link":"#_1-解决免交互问题：","children":[]},{"level":2,"title":"2.ssh-copy-id分发公钥原理：","slug":"_2-ssh-copy-id分发公钥原理：","link":"#_2-ssh-copy-id分发公钥原理：","children":[]},{"level":2,"title":"3.分发脚本：","slug":"_3-分发脚本：","link":"#_3-分发脚本：","children":[]},{"level":2,"title":"4.if判断比较信息：","slug":"_4-if判断比较信息：","link":"#_4-if判断比较信息：","children":[]},{"level":2,"title":"5.分发公钥问题说明：","slug":"_5-分发公钥问题说明：","link":"#_5-分发公钥问题说明：","children":[]},{"level":2,"title":"6.排错方法：","slug":"_6-排错方法：","link":"#_6-排错方法：","children":[]}],"relativePath":"pages/posts/SSH服务初识.md","path":"/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/SSH服务初识.md","lastUpdated":1671090556000}'),l=JSON.parse('{"title":"SSH服务初识","description":"","frontmatter":{"title":"SSH服务初识","categories":"Linux技术","tags":["SSH"],"date":"2018-09-08T16:38:00.000Z"},"headers":[{"level":2,"title":"1.管理端服务器","slug":"_1-管理端服务器","link":"#_1-管理端服务器","children":[]},{"level":2,"title":"2.被管理端服务器","slug":"_2-被管理端服务器","link":"#_2-被管理端服务器","children":[]},{"level":2,"title":"1.解决免交互问题：","slug":"_1-解决免交互问题：","link":"#_1-解决免交互问题：","children":[]},{"level":2,"title":"2.ssh-copy-id分发公钥原理：","slug":"_2-ssh-copy-id分发公钥原理：","link":"#_2-ssh-copy-id分发公钥原理：","children":[]},{"level":2,"title":"3.分发脚本：","slug":"_3-分发脚本：","link":"#_3-分发脚本：","children":[]},{"level":2,"title":"4.if判断比较信息：","slug":"_4-if判断比较信息：","link":"#_4-if判断比较信息：","children":[]},{"level":2,"title":"5.分发公钥问题说明：","slug":"_5-分发公钥问题说明：","link":"#_5-分发公钥问题说明：","children":[]},{"level":2,"title":"6.排错方法：","slug":"_6-排错方法：","link":"#_6-排错方法：","children":[]}],"relativePath":"pages/posts/SSH服务初识.md","path":"/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/SSH服务初识.md","lastUpdated":1671090556000}'),g={name:"pages/posts/SSH服务初识.md",data(){return{data:l,frontmatter:l.frontmatter}},setup(){m("pageData",l)}},y={id:"第一章-远程连接服务概念介绍",tabindex:"-1"},b=s("p",null,"SSH: 系统默认配置 22 默认可以使用root用户进行登录 数据信息进行加密 TELNET：网络设备默认开启 23 默认只能使用普通用户进行登录 数据信息显示明文",-1),k={id:"第二章-远程连接服务连接原理",tabindex:"-1"},S=s("p",null,"openssh 远程连接数据包进行加密处理 openssl 网站访问请求信息和响应信息进行加密（HTTPS） 连接示意图：",-1),v=s("p",null,[s("img",{src:"https://vlinux-1259060227.cos.ap-shanghai.myqcloud.com/www-vlinux-cn-blog-img/gitee-backup/img-master/image/14248468-af025c4191bb5a68.png",alt:"SSH密钥认证过程"})],-1),$=s("p",null,"原理总结：",-1),A=s("pre",null,[s("code",null,`01. 客户端 - 服务端   请求建立ssh远程连接 
02. 服务端 - 客户端   请求确认公钥信息
...
`)],-1),z=s("p",null,"第二个历程：分发公钥",-1),q=s("pre",null,[s("code",null,`[root@m01 ~]# ssh-copy-id -i ~/.ssh/id_dsa.pub root@172.16.1.31
...
`)],-1),I=s("p",null,"第三个历程：检查确认",-1),B=s("pre",null,[s("code",null,`[root@m01 ~]# ssh 172.16.1.31
...
nfs01
[root@m01 ~]# 
`)],-1),U={id:"_2-被管理端服务器",tabindex:"-1"},V=s("p",null,"第一个历程：检查确认",-1),E=s("pre",null,[s("code",null,`[root@nfs01 ~]# cd /root/.ssh/
[root@nfs01 ~/.ssh]# ll
总用量 8
...
`)],-1),j={id:"_4-if判断比较信息：",tabindex:"-1"},W=s("pre",null,[s("code",null,`   =    -eq   equal
    >    -gt   greater than
    <    -lt   less than
    >=   -ge   greater equal
    <=   -le   less equal
    <>   -ne   no equal
`)],-1),G={id:"_5-分发公钥问题说明：",tabindex:"-1"},ss=s("pre",null,[s("code",null,`01. 密码信息不正确
...
`)],-1),is=s("p",null,"8.ssh-copy id命令解释",-1),as=s("pre",null,[s("code",null,`   ssh $1 "exec sh -c 'cd; umask 077; test -d .ssh || mkdir .ssh ; cat >> .ssh/authorized_keys && (test -x /sbin/restorecon && /sbin/restorecon .ssh .ssh/authorized_keys >/dev/null 2>&1 || true)'"

01. 远程连接到指定主机
02. 切换到家目录，临时修改umask数值
03. 判断是否存在.ssh目录，不存在创建.ssh 
04. 生成.ssh/authorized_keys,并且把公钥信息保存在此文件中
`)],-1),ls=s("p",null,"9.总结：掌握批量分发公钥脚本编写能力",-1),ds=s("pre",null,[s("code",null,`01. 解决免交互问题： yes/no  密码问题
...
`)],-1),bs=s("p",null,"[player id='712292593' type='collect' autoplay='true'/]",-1);function ks(i,Ss,vs,$s,d,As){const t=f,h=r;return u(),_(h,{frontmatter:d.frontmatter,data:d.data},{"main-content-md":n(()=>[s("h1",y,[e("第一章 远程连接服务概念介绍 "),o(t,{class:"header-anchor",href:"#第一章-远程连接服务概念介绍","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),b,s("h1",k,[e("第二章 远程连接服务连接原理 "),o(t,{class:"header-anchor",href:"#第二章-远程连接服务连接原理","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),S,v,$,A,w,H,x,P,s("h1",N,[e("第三章 基于密钥方式实现远程连接步骤： "),o(t,{class:"header-anchor",href:"#第三章-基于密钥方式实现远程连接步骤：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),s("h2",L,[e("1.管理端服务器 "),o(t,{class:"header-anchor",href:"#_1-管理端服务器","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),T,C,z,q,I,B,s("h2",U,[e("2.被管理端服务器 "),o(t,{class:"header-anchor",href:"#_2-被管理端服务器","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),V,E,s("h1",J,[e("第四章 免交户分发密钥 "),o(t,{class:"header-anchor",href:"#第四章-免交户分发密钥","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),K,s("h2",D,[e("1.解决免交互问题： "),o(t,{class:"header-anchor",href:"#_1-解决免交互问题：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),M,Y,Z,F,s("h2",O,[e("2.ssh-copy-id分发公钥原理： "),o(t,{class:"header-anchor",href:"#_2-ssh-copy-id分发公钥原理：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),Q,s("h2",R,[e("3.分发脚本： "),o(t,{class:"header-anchor",href:"#_3-分发脚本：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),X,s("h2",j,[e("4.if判断比较信息： "),o(t,{class:"header-anchor",href:"#_4-if判断比较信息：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),W,s("h2",G,[e("5.分发公钥问题说明： "),o(t,{class:"header-anchor",href:"#_5-分发公钥问题说明：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),ss,s("h2",es,[e("6.排错方法： "),o(t,{class:"header-anchor",href:"#_6-排错方法：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),ns,ts,os,is,as,ls,ds,s("h1",hs,[e("第五章 SSH服务端配置文件说明： "),o(t,{class:"header-anchor",href:"#第五章-ssh服务端配置文件说明：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),rs,s("h1",cs,[e("第六章 SSH防范远程入侵方案 亡羊补牢 -- 未雨绸缪 "),o(t,{class:"header-anchor",href:"#第六章-ssh防范远程入侵方案-亡羊补牢-未雨绸缪","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),s("p",null,[e("参考博客"),o(t,{href:"http://blog.51cto.com/phenixikki/1546669",target:"_blank",rel:"noreferrer"},{default:n(()=>[e("https://blog.51cto.com/phenixikki/1546669")]),_:1})]),_s,s("h1",us,[e("第七章 课程知识回顾说明： "),o(t,{class:"header-anchor",href:"#第七章-课程知识回顾说明：","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),ps,fs,ms,gs,ys,p("more"),bs]),"main-header":n(()=>[a(i.$slots,"main-header")]),"main-header-after":n(()=>[a(i.$slots,"main-header-after")]),"main-nav":n(()=>[a(i.$slots,"main-nav")]),"main-content":n(()=>[a(i.$slots,"main-content")]),"main-content-after":n(()=>[a(i.$slots,"main-content-after")]),"main-nav-before":n(()=>[a(i.$slots,"main-nav-before")]),"main-nav-after":n(()=>[a(i.$slots,"main-nav-after")]),comment:n(()=>[a(i.$slots,"comment")]),footer:n(()=>[a(i.$slots,"footer")]),aside:n(()=>[a(i.$slots,"aside")]),"aside-custom":n(()=>[a(i.$slots,"aside-custom")]),default:n(()=>[a(i.$slots,"default")]),_:3},8,["frontmatter","data"])}const Ts=c(g,[["render",ks]]);export{Ls as __pageData,Ts as default};
