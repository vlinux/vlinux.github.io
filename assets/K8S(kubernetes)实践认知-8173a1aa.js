...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"<none> <none>")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),X=s("p",null,[s("strong",null,"Service网络")],-1),Q=s("p",null,"Service是为Pod提供访问和负载均衡的网络地址段，如下图所示。",-1),ss=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get service")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ns=s("p",null,"Kubernetes的组件和知识绝非如此，快速入门可以先了解这么多，下一章节，我们先快速的部署一个Kubernetes集群。",-1),es={id:"使用kubeadm部署kubernetes-v1-16-4",tabindex:"-1"},ls=s("p",null,"想要快速的体验Kubernetes的功能，官方提供了非常多的部署方案，可以使用官方提供的kubeadm以容器的方式运行Kubernetes集群，也可以使用二进制方式部署更有利于理解Kubernetes的架构，我们先使用kubeadm快速的部署一个Kubernetes集群后，学习Kubernetes的使用，然后动手使用二进制的方式来深入理解Kubernetes架构。",-1),as=s("blockquote",null,[s("p",null,"注意：请不要把目光仅仅放在部署上，要慢慢的了解其本质。")],-1),os=s("p",null,"Kubernetesv1.13版本发布后，kubeadm才正式进入GA，可以生产使用。目前Kubernetes的对应镜像仓库，在国内阿里云也有了镜像站点，使用kubeadm部署Kubernetes集群变得简单并且容易了很多，本文使用kubeadm带领大家快速部署Kubernetes v1.16.2版本。",-1),ts=s("p",null,[s("strong",null,"实验环境准备")],-1),cs=s("p",null,"在本书的实验环境的基础上，我们如下来分配角色：",-1),is=s("thead",null,[s("tr",null,[s("th",null,"主机名"),s("th",null,"IP地址（NAT）"),s("th",null,"最低配置"),s("th",null,"描述")])],-1),rs=s("td",null,"eth0:192.168.56.11",-1),ps=s("td",null,"1CPU/1G内存",-1),As=s("td",null,"Kubernets Master/Etcd节点",-1),ds=s("td",null,"eth0:192.168.56.12",-1),Cs=s("td",null,"1CPU/1G内存",-1),us=s("td",null,"Kubernets Node节点",-1),hs=s("td",null,"eth0:192.168.56.13",-1),ys=s("td",null,"1CPU/1G内存",-1),Ds=s("td",null,"Kubernets Node节点",-1),gs=s("tr",null,[s("td",null,"Service网段"),s("td",null,"10.1.0.0/16"),s("td"),s("td")],-1),ms=s("tr",null,[s("td",null,"Pod网段"),s("td",null,"10.2.0.0/16"),s("td"),s("td")],-1),_s=s("tr",null,[s("td",null,"备注"),s("td",null,"如果有条件可以部署多个Kubernets node，实验效果更佳。"),s("td"),s("td")],-1),ks={id:"部署docker",tabindex:"-1"},bs=s("p",null,"首先需要在所有Kubernetes集群的节点中安装Docker和kubeadm。",-1),fs=s("p",null,[s("strong",null,"1.设置使用国内Yum源")],-1),vs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cd /etc/yum.repos.d/")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),xs=s("p",null,[s("strong",null,"2.安装指定的Docker版本")],-1),Ps=s("p",null,"当前v1.16.2支持的Docker版本有v1.13.1, 17.03, 17.06, 17.09, 18.06, 18.09,可以通过下面命令查看：",-1),Ss=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# yum list docker-ce.x86_64 --showduplicates | sort -r")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Es=s("p",null,[s("strong",null,"3.安装Docker18.09版本")],-1),Ns=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# yum -y install docker-ce-18.09.9-3.el7 docker-ce-cli-18.09.9-3.el7")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Rs=s("p",null,[s("strong",null,"4.设置cgroup驱动使用systemd")],-1),Ts=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# mkdir /etc/docker")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ks=s("p",null,[s("strong",null,"5.启动后台进程")],-1),Is=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl enable docker && systemctl start docker")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ms=s("p",null,[s("strong",null,"6.查看Docker版本")],-1),ws=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# docker --version")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Docker version 18.09.9, build 039a7df9ba")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ls={id:"部署kubadm和kubelet",tabindex:"-1"},js=s("p",null,"在Kubernetes集群的所有节点上部署完毕Docker后，还需要全部部署kubeadm和kubelet，其中kubeadm是管理工具，kubelet是一个服务，用于启动Kubernetes对应的服务。",-1),Os=s("p",null,[s("strong",null,"1.设置kubernetes YUM仓库")],-1),Gs=s("p",null,"这里在官方文档的基础上修改为了国内阿里云的yum仓库，",-1),Us=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim /etc/yum.repos.d/kubernetes.repo")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Vs=s("blockquote",null,[s("p",null,"注意：最下面一行gpgkey的两个URL地址之间是空格，因为排版问题可能导致换行。")],-1),Hs=s("p",null,[s("strong",null,"2.安装软件包")],-1),Ys=s("p",null,"由于版本更新频繁，请指定对应的版本号，本文采用1.16.2版本，其它版本未经测试，如果不指定版本默认安装最新版本。",-1),Fs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# yum install -y kubelet-1.16.2 kubeadm-1.16.2 kubectl-1.16.2 ipvsadm")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Bs=s("p",null,[s("strong",null,"3.配置kubelet")],-1),$s=s("p",null,"默认情况下，Kubelet不允许所在的主机存在交换分区，后期规划的时候，可以考虑在系统安装的时候不创建交换分区，针对已经存在交换分区的可以设置忽略禁止使用Swap的限制，不然无法启动Kubelet。",-1),qs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim /etc/sysconfig/kubelet")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Js=s("p",null,"在所有节点上关闭SWAP",-1),zs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# swapoff -a")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ws=s("p",null,[s("strong",null,"4.设置内核参数")],-1),Zs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cat <<EOF >  /etc/sysctl.d/k8s.conf")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"EOF")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Xs=s("p",null,"使配置生效",-1),Qs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# sysctl --system")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),sn=s("p",null,[s("strong",null,"5.启动kubelet并设置开机启动")],-1),nn=s("p",null,"注意，此时kubelet是无法正常启动的，可以查看/var/log/messages有报错信息，等待执行初始化之后即可正常，为正常现象。",-1),en=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl enable kubelet && systemctl start kubelet")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ln=s("p",null,[s("strong",null,"6.使用IPVS进行负载均衡")],-1),an=s("p",null,"在Kubernetes集群中Kube-Proxy组件负载均衡的功能，默认使用iptables，生产环境建议使用ipvs进行负载均衡。在所有节点启用ipvs模块",-1),on=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim /etc/sysconfig/modules/ipvs.modules")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),tn=s("p",null,"查看模块是否加载正常",-1),cn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# lsmod | grep -e ip_vs -e nf_conntrack_ipv4")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),rn={id:"初始化集群部署master",tabindex:"-1"},pn=s("p",null,"在所有节点上安装完毕后，在linux-node1这台Master节点上进行集群的初始化工作。",-1),An=s("p",null,[s("strong",null,"1.导出所有默认的配置")],-1),dn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubeadm config print init-defaults > kubeadm.yaml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Cn=s("p",null,"上面的命令会生成一个默认配置的kubeadm配置文件，然后在此基础上进行修改即可。",-1),un=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cat kubeadm.yaml ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),hn=s("p",null,[s("strong",null,"2. 执行初始化操作")],-1),yn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubeadm init --config kubeadm.yaml")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Dn=s("p",null,"如果遇到上面这样的报错，是因为在实验环境开启了交换分区，以及CPU的核数小于2造成的，可以使用--ignore-preflight-errors=进行忽略。 --ignore-preflight-errors=：忽略运行时的错误，例如上面目前存在[ERROR NumCPU]和[ERROR Swap]，忽略这两个报错就是增加--ignore-preflight-errors=NumCPU 和--ignore-preflight-errors=Swap的配置即可。",-1),gn=s("p",null,"再次执行初始化操作：",-1),mn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubeadm init --config kubeadm.yaml \\")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),_n=s("p",null,"执行完毕后，会在当前输出下停留，等待下载Kubernetes组件的Docker镜像。根据你的网络情况，可以持续1-5分钟，你也可以使用docker images查看下载的镜像。镜像下载完毕之后，就会进行初始操作：",-1),kn=s("p",null,"这里省略了所有输出，初始化操作主要经历了下面15个步骤，每个阶段均输出均使用[步骤名称]作为开头：",-1),bn=s("ol",null,[s("li",null,"[init]：指定版本进行初始化操作"),s("li",null,"[preflight] ：初始化前的检查和下载所需要的Docker镜像文件。"),s("li",null,"[kubelet-start]：生成kubelet的配置文件”/var/lib/kubelet/config.yaml”，没有这个文件kubelet无法启动，所以初始化之前的kubelet实际上启动失败。"),s("li",null,"[certificates]：生成Kubernetes使用的证书，存放在/etc/kubernetes/pki目录中。"),s("li",null,"[kubeconfig] ：生成 KubeConfig文件，存放在/etc/kubernetes目录中，组件之间通信需要使用对应文件。"),s("li",null,"[control-plane]：使用/etc/kubernetes/manifest目录下的YAML文件，安装 Master组件。"),s("li",null,"[etcd]：使用/etc/kubernetes/manifest/etcd.yaml安装Etcd服务。"),s("li",null,"[wait-control-plane]：等待control-plan部署的Master组件启动。"),s("li",null,"[apiclient]：检查Master组件服务状态。"),s("li",null,"[uploadconfig]：更新配置"),s("li",null,"[kubelet]：使用configMap配置kubelet。"),s("li",null,"[patchnode]：更新CNI信息到Node上，通过注释的方式记录。"),s("li",null,"[mark-control-plane]：为当前节点打标签，打了角色Master，和不可调度标签，这样默认就不会使用Master节点来运行Pod。"),s("li",null,"[bootstrap-token]：生成token记录下来，后边使用kubeadm join往集群中添加节点时会用到"),s("li",null,"[addons]：安装附加组件CoreDNS和kube-proxy")],-1),fn=s("p",null,"成功执行之后，你会看到下面的输出：",-1),vn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Your Kubernetes master has initialized successfully!")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),xn=s("p",null,"如果执行失败，那意味着之前的操作存在问题，检查顺序如下：",-1),Pn=s("ul",null,[s("li",null,"基础环境"),s("li",null,"主机名是否可以解析，SELinux，iptables是否关闭。"),s("li",null,"交换分区是否存在free -m查看"),s("li",null,"内核参数是否修改、IPVS是否修改（目前阶段不会造成失败）"),s("li",null,"基础软件"),s("li",null,"Docker是否安装并启动"),s("li",null,"Kubelet是否安装并启动"),s("li",null,"执行kubeadm是否有别的报错是否忽略"),s("li",null,"systemctl status kubelet查看kubelet是否启动"),s("li",null,"如果kubelet无法启动，查看日志有什么报错，并解决报错。"),s("li",null,"以上都解决完毕，需要重新初始化"),s("li",null,"kubeadm reset 进行重置（生产千万不要执行，会直接删除集群）"),s("li",null,"根据kubeadm reset 提升，清楚iptables和LVS。")],-1),Sn=s("p",null,"请根据上面输出的要求配置kubectl命令来访问集群。",-1),En=s("p",null,[s("strong",null,"3.为kubectl准备Kubeconfig文件。")],-1),Nn=s("p",null,"kubectl默认会在执行的用户家目录下面的.kube目录下寻找config文件。这里是将在初始化时[kubeconfig]步骤生成的admin.conf拷贝到.kube/config。",-1),Rn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# mkdir -p $HOME/.kube")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Tn=s("p",null,"在该配置文件中，记录了API Server的访问地址，所以后面直接执行kubectl命令就可以正常连接到API Server中。",-1),Kn=s("p",null,[s("strong",null,"4.使用kubectl命令查看组件状态")],-1),In=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get cs")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Mn=s("p",null,"**知识回顾：为什么上面的输出没有显示API Server组件的状态",-1),wn=s("p",null,"因为API Server是Kubernetes集群的入口，所有和Kubernetes集群的交互都必须经过APIServer，kubectl命令也是连接到API Server上进行交互，所以如果能够正常使用kubectl执行命令，意味着API Server运行正常。",-1),Ln=s("p",null,[s("strong",null,"5.使用kubectl获取Node信息")],-1),jn=s("p",null,"目前只有一个节点，角色是Master，状态是NotReady。",-1),On=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get node")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Yn=s("p",null,"【部署Flannel网络插件】（推荐） 部署Flannel网络插件需要修改Pod的IP地址段，修改为和你初始化一直的网段，可以先下载Flannel的YAML文件修改后，再执行。",-1),Fn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# git clone --depth 1 https://github.com/coreos/flannel.git")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Bn=s("p",null,"部署Flannel",-1),$n=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 Documentation]# kubectl create -f kube-flannel.yml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),qn=s("p",null,"查看Pod状态",-1),Jn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 Documentation]# kubectl get pod -n kube-system")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ee=s("p",null,[s("strong",null,"2.在Node节点执行")],-1),le=s("p",null,"注意如果节点有交换分区，需要增加--ignore-preflight-errors=Swap。",-1),ae=s("p",null,"部署linux-node2",-1),oe=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node2 ~]# kubeadm join 192.168.56.11:6443 --token isggqa.xjwsm3i6nex91d2x --discovery-token-ca-cert-hash sha256:718827895a9a5e63dfa9ff54e16ad6dc0c493139c9c573b67ad66968036cd569 --ignore-preflight-errors=Swap")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),te=s("p",null,"部署linux-node3",-1),ce=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node3 ~]# kubeadm join 192.168.56.11:6443 --tokenisggqa.xjwsm3i6nex91d2x --discovery-token-ca-cert-hash sha256:718827895a9a5e63dfa9ff54e16ad6dc0c493139c9c573b67ad66968036cd569 --ignore-preflight-errors=Swap")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ie=s("p",null,"这个时候kubernetes会使用DaemonSet在所有节点上都部署canal/flannel和kube-proxy。部署完毕之后节点即部署完毕。DaemonSet的内容后面会讲解。",-1),re=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    [root@linux-node1 ~]# kubectl get daemonset --all-namespaces")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),pe=s("p",null,"待所有Pod全部启动完毕之后，节点就恢复Ready状态。",-1),Ae=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    [root@linux-node1 ~]# kubectl get pod --all-namespaces")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),de=s("strong",null,"查看所有节点",-1),Ce=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"**如何给Node加上Roles标签**")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'ETag: "5c240d0d-264"')]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Accept-Ranges: bytes")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ue=s("p",null,[n("``` "),s("strong",null,"7.测试NodePort，外部访问。")],-1),he=s("p",null,[s("img",{src:"http://k8s.unixhot.com/kubernetes/media/1f9d523f359ce6d49515d04703d8e941.png",alt:"img"})],-1),ye=s("p",null,"这一切看起来似乎不是十分完美，但是现在你已经拥有了一个Kubernetes集群，接下来就可以继续探索Kubernetes的世界了。",-1),De={id:"公有云中的kubernetes",tabindex:"-1"},ge=s("p",null,"截止2019年2月，大多数公有云已经提供了容器Kubernetes的产品服务，对于使用公有云的用户来说，最佳实践是直接购买公有云产品，而非自己部署Kubernetes集群，主要是因为公有云已经将网络和存储与Kubernetes集成好了，解决了生产应用的难题。",-1),me={id:"阿里云中的kubernetes",tabindex:"-1"},_e=s("p",null,"国内阿里云提供了容器服务 Kubernetes 版（简称 ACK）提供高性能可伸缩的容器应用管理能力，支持企业级 Kubernetes 容器化应用的全生命周期管理。容器服务 Kubernetes 版简化集群的搭建和扩容等工作，整合阿里云虚拟化、存储、网络和安全能力，打造云端最佳的 Kubernetes 容器化应用运行环境。",-1),ke=s("p",null,[s("strong",null,"阿里云Kubernetes模式")],-1),be=s("p",null,"容器服务Kubernetes版包含了经典Dedicated Kubernetes以及Serverless两种形态，方便您按需选择。",-1),fe=s("ul",null,[s("li",null,"经典Dedicated Kubernetes模式：您可以对集群基础设施和容器应用进行更细粒度的控制，比如选择宿主机实例规格和操作系统，指定Kubernetes 版本、自定义 Kubernetes 特性开关设置等。阿里云 Kubernetes 服务负责为集群创建底层云资源，升级等自动化运维操作。而您需要规划、维护、升级服务器集群，手动或自动在集群中添加或删除服务器。"),s("li",null,"Serverless 模式：您无需创建底层虚拟化资源，可以利用 Kubernetes 命令指明应用容器镜像、CPU 和内存要求以及对外服务方式，直接启动。")],-1),ve=s("p",null,[s("strong",null,"阿里云Kubernetes产品架构")],-1),xe=s("p",null,[s("img",{src:"http://k8s.unixhot.com/kubernetes/media/43688d33a81f2bd6af354d0715b6b297.png",alt:"C:UsersjasonDesktop15447553537457_zh-CN.png"})],-1),Pe=s("p",null,[s("strong",null,"阿里云Kubernetes创建")],-1),Se=s("p",null,"默认情况下可以在阿里云中自行创建5个集群，每个集群最多可以添加 40 个节点。如需更高配额，需要提交工单申请。",-1),Ee=s("p",null,[s("img",{src:"http://k8s.unixhot.com/kubernetes/media/4c165d0ebc842862595f9fd0f4650d43.png",alt:"img"})],-1),Ne=s("p",null,"阿里云将网络、存储、安全等方面已经进行了深度集成，在创建Kubernetes集群时，阿里云容器服务提供两种网络插件：Terway和Flannel：",-1),Re=s("ul",null,[s("li",null,"Flannel：使用的是简单稳定的社区的Flannel CNI插件，配合阿里云的VPC的高速网络，能给集群高性能和稳定的容器网络体验，但功能偏简单，支持的特性少，例如：不支持基于Kubernetes标准的Network Policy。"),s("li",null,"Terway：是阿里云容器服务自研的网络插件，功能上完全兼容Flannel，支持将阿里云的弹性网卡分配给容器，支持基于Kubernetes标准的NetworkPolicy来定义容器间的访问策略，支持对单个容器做带宽的限流。对于不需要使用Network Policy的用户，可以选择Flannel，其他情况建议选择Terway。了解更多Terway网络插件的相关内容，请参见Terway网络插件。")],-1),Te=s("p",null,"最终阿里云会使用kubeadm帮你创建一个指定版本的Kubernetes集群。",-1),Ke={id:"私有云中的kubernetes",tabindex:"-1"},Ie=s("p",null,[s("strong",null,"内网部署Kubernetes")],-1),Me=s("p",null,"很多企业需要内网部署Kubernetes但是内网又无法访问外网，就需要本地化部署，无忘了本地话部署主要包括两个方面，一个是软件仓库的准备，一个是Kubernetes镜像的准备。",-1),we=s("ol",null,[s("li",null,"准备内网YUM仓库（略）"),s("li",null,"准备Docker Registry（请参考Harbor章节）"),s("li",null,"下载并提交镜像到Harbor中，然后将Harbor的镜像部署直接COPY到生产环境中")],-1),Le=s("p",null,"下载脚本如下，请根据需求自行修改：",-1),je=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim k8s-images.sh")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"#!/bin/bash")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Oe={id:"第五部分-将应用迁移至kubernetes",tabindex:"-1"},Ge={id:"_6-第一步：将应用封装进容器中",tabindex:"-1"},Ue={id:"第一步：将应用封装进容器中",tabindex:"-1"},Ve=s("p",null,"在之前的容器镜像实战中，我们已经学习了如何将应用容器化，这里我们将下载使用两个官方的Nginx镜像来完成接下来的实验。",-1),He={id:"部署harbor镜像仓库",tabindex:"-1"},Ye=s("p",null,"生产环境中可以使用Harbor来管理Docker镜像，请参考之前章节的内容完成Harbor镜像仓库的部署工作，并在Harbor中创建一个devopsedu的项目。",-1),Fe=s("p",null,[s("img",{src:"http://k8s.unixhot.com/kubernetes/media/093b4b731c05b54a1b8426e924f93d45.png",alt:"img"})],-1),Be={id:"制作实验用的docker镜像",tabindex:"-1"},$e=s("p",null,"这里不再演示Docker镜像的构建，直接下载两个官方镜像作为案例。",-1),qe=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# docker pull nginx:1.13.12")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# docker pull nginx:1.14.0")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Je={id:"配置docker仓库",tabindex:"-1"},ze=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root\\@linux-node1 ~]# vim /etc/docker/daemon.json")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),We={id:"登录harbor镜像仓库",tabindex:"-1"},Ze=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# docker login 192.168.56.11")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Xe={id:"提交镜像到registry",tabindex:"-1"},Qe=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# docker tag nginx:1.13.12")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),sl=s("p",null,"在上面的步骤中，模拟了生产环境如何构建和提交镜像，如果对于构建和提交镜像有疑问可以复习第3章的内容。",-1),nl={id:"_7-第二步：将容器封装到pod中",tabindex:"-1"},el=s("p",null,"Pod是Kubernetes最小的管理单元，一个Pod可以代表一个运行在集群里的进程。之前是在宿主机上运行不同的进程，现在是运行不同的Pod。前面介绍过Pod是一个逻辑架构的组件，Pod里封装了一个（或者多个）应用容器，存储资源和IP地址。",-1),ll=s("p",null,[s("strong",null,"为什么要造一个Pod出来？"),n(" 学习Kubernetes遇到的最多的名称可能就是Pod了，其它开源的容器管理平台例如Mesos直接管理和调度的是容器，但是Kubernetes确是Pod，它在容器上面做了一层封装，方便用户将一组紧耦合的容器，放置在一个共享资源的单元中。对于很多没有此类场景的初学者，可以暂时将Pod看做是容器的一个壳，你也完全可以只在Pod中运行一个容器，随着学习的深入再慢慢理解。 Kubernetes运行Pod的两种方式：")],-1),al=s("ul",null,[s("li",null,"Pod里只运行一个单独容器，是Kubernetes最常见的使用场景；在这种情况下，可以把Pod看做是一个单独容器的连接器，Kubernetes通过Pod去管理容器，作为使用者几乎不用关心容器。"),s("li",null,"Pod里运行多个有关系容器。例如如果使用Nginx+Tomcat运行Java应用，可以制作一个镜像里面包含了Nginx+Tomcat，也可以分别制作两个镜像Nginx镜像和Tomcat镜像，如果使用Kubernetes就需要使用Pod，如果将Nginx和Tomcat单独放在两个Pod里面来管理，就会面临很多很多问题。这个时候，就可以把这两个容器放置在一个Pod中。")],-1),ol={id:"pod管理",tabindex:"-1"},tl=s("p",null,"在Kubernetes中使用YAML格式来描述一个Pod。",-1),cl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim nginx-pod.yaml ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),il=s("p",null,"Pod的YAML描述内容还有很多，在使用kubeadm部署Kubernetes的时候，就是使用静态Pod的方式运行的相关服务，YAML文件存放在，当然现在很多配置还是看不懂的，带着问题继续学习。",-1),rl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# ls -l /etc/kubernetes/manifests/")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),pl=s("p",null,"创建Pod",-1),Al=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl create -f nginx-pod.yaml ")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'pod "nginx-pod" created')]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),dl=s("p",null,"查看Pod",-1),Cl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get pod")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"NAME                                READY     STATUS    RESTARTS   AGE")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"nginx-pod                           1/1       Running   0          49s")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ul=s("p",null,"查看Pod更多信息",-1),hl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get pod -o wide")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),yl=s("p",null,"查看Pod详情",-1),Dl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl describe pod nginx-pod")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Name:         nginx-pod")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),gl=s("p",null,"查看Pod日志",-1),ml=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl logs pod/nginx-pod")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),_l=s("p",null,[s("strong",null,"Pod中的镜像拉取策略"),n(" 当kubelet尝试拉取指定的镜像时，[imagePullPolicy]和镜像的标签会生效。")],-1),kl=s("ul",null,[s("li",null,"imagePullPolicy: IfNotPresent：仅当镜像在本地不存在时镜像才被拉取。"),s("li",null,"imagePullPolicy: Always：每次启动 pod 的时候都会拉取镜像。")],-1),bl=s("p",null,"省略imagePullPolicy，镜像标签为:latest或被省略，Always被应用。 imagePullPolicy被省略，并且镜像的标签被指定且不是:latest，IfNotPresent被应用。 imagePullPolicy: Never：镜像被假设存在于本地。 没有尝试拉取镜像。",-1),fl={id:"_7-3-第三步：使用controllers管理pod",tabindex:"-1"},vl=s("p",null,"在实际的生产环境中，我们其实很少单独创建Pod，而是通过控制器来进行Pod的管理，Kubernetes提供了很多的控制器，一个 Controllers 可以创建和管理很多个 Pod, 也提供复制、初始化，以及提供集群范围的自我恢复的功能。比如说： 如果一个节点宕机，Controller 将调度一个在其他节点上完全相同的 pod 来自动取代当前的 pod。",-1),xl={id:"_8-1-replication-controller控制器",tabindex:"-1"},Pl={id:"_8-2-replica-sets控制器",tabindex:"-1"},Sl={id:"_8-3-deployment控制器",tabindex:"-1"},El={id:"_8-4-daemonset控制器",tabindex:"-1"},Nl=s("p",null,"DaemonSet 确保全部（或者一些）Node 上运行一个 Pod 的副本。当有 Node 加入集群时，也会为他们新增一个 Pod 。当有 Node 从集群移除时，这些 Pod 也会被回收。删除 DaemonSet 将会删除它创建的所有 Pod。 使用 DaemonSet 的一些典型用法：",-1),Rl=s("ul",null,[s("li",null,"运行集群存储 daemon，例如在每个 Node 上运行 glusterd、ceph。"),s("li",null,"在每个 Node 上运行日志收集 daemon，例如filebeat、logstash。"),s("li",null,"在每个 Node 上运行监控 daemon，例如 Prometheus Node Exporter、collectd、Datadog 代理、Zabbix Agent。")],-1),Tl=s("p",null,[s("strong",null,"创建DaemonSet")],-1),Kl=s("p",null,"DaemonSet的描述文件和Deployment非常相似，只需要修改Kind，并去掉副本数量的配置即可",-1),Il=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 example]# vim nginx-daemonset.yaml")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        ports:")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        - containerPort: 80")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ml=s("p",null,"查看Pod在Node上的分布",-1),wl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get pod -o wide")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"NAME                    READY     STATUS    RESTARTS   AGE       IP           NODE")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ql=s("p",null,"访问Servce IP",-1),Jl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# curl --head 10.1.181.45")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"HTTP/1.1 200 OK")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ea=s("p",null,"查看Service，可以放心CLUSTER-IP为None",-1),la=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get service mysql-service")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"NAME            TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)    AGE")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"mysql-service   ClusterIP   None         <none>        3306/TCP   17s")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),aa=s("p",null,"2.创建一个Endpoint",-1),oa=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim mysql-endpoint.yaml ")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: v1")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ta=s("p",null,"3.查看Service和Endpoint的关联",-1),ca=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get ep mysql-service")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ga={id:"_11-第六步：使用pv和pvc管理数据存储",tabindex:"-1"},ma=s("p",null,"截止目前我们所启动Pod的容器中的数据存储都是临时的，因此Pod重启或者被删除的时候，产生在容器中的数据会发生丢失。实际应用中，我们有些应用是无状态，有些应用则需要保持状态数据，确保Pod重启之后能够读取到之前的状态数据，有些应用则作为集群提供服务。这三种服务归纳为无状态服务、有状态服务以及有状态的集群服务，其中后面两个存在数据保存与共享的需求，因此就要采用容器外的存储方案。 Kubernetes中存储中有四个重要的概念：Volume、PersistentVolume（PV）、PersistentVolumeClaim （PVC）、StorageClass。掌握了这四个概念，就掌握了Kubernetes中存储系统的核心。",-1),_a={id:"_11-1-kubernetes-volume",tabindex:"-1"},ka={id:"_11-2-persistentvolume（pv）",tabindex:"-1"},ba=s("p",null,"PersistentVolume（PV）是由管理员设置的存储，它是群集的一部分。就像节点是集群中的资源一样，PV 也是集群中的资源。 PV 是 Volume 之类的卷插件，但具有独立于使用 PV 的 Pod 的生命周期。此 API 对象包含存储实现的细节，即 NFS、iSCSI 或特定于云供应商的存储系统。",-1),fa=s("p",null,[s("strong",null,"1.安装并配置NFS")],-1),va=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# yum install -y nfs-utils rpcbind")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),xa=s("p",null,"启动NFS",-1),Pa=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl enable rpcbind nfs")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl start rpcbind nfs")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Sa=s("p",null,[s("strong",null,"2.创建并查看PV")],-1),Ea=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim nfs-pv.yaml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: v1")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Na=s("p",null,"查看创建的PV",-1),Ra=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get pv")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      storage: 1Gi")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  storageClassName: nfs")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),wa=s("p",null,"创建并查看PVC",-1),La=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl create -f nfs-pvc.yaml ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ja=s("p",null,"2.使用PVC",-1),Oa=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim nginx-deployment-pvc.yaml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: apps/v1")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),vo=s("p",null,"如何访问Service名称",-1),xo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/ # ping -c 3 wordpress-service.default.svc.cluster.local")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Po=s("p",null,"DNS查询策略",-1),So=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get pod dns-test -o yaml | grep dnsPolicy")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  dnsPolicy: ClusterFirst")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Eo=s("ul",null,[s("li",null,"Default: Pod从其运行的节点中继承名称解析配置。"),s("li",null,"ClusterFirst:（默认策略）与配置的群集域名后缀不匹配的任何DNS查询都将转发到从节点继承的上游名称服务器。"),s("li",null,"ClusterFirstWithHostNet: 如果Pod使用了hostNetwork（例如Ingress Controller Treafik就是使用了hostNetwok），应显式设置其DNS策略为“ClusterFirstWithHostNet”。"),s("li",null,"None: 它允许Pod忽略Kubernetes环境中的DNS设置，这时候会使用Pod Spec中的dnsConfig字段提供的DNS设置。")],-1),No={id:"应用的dns管理-1",tabindex:"-1"},Ro={id:"_15-1-使用configmap管理应用配置",tabindex:"-1"},To={id:"通过kubectl命令创建configmap",tabindex:"-1"},Ko=s("p",null,[s("strong",null,"创建一个名称为cmd-config的ConfigMap")],-1),Io=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl create configmap cmd-config --from-literal=host=www.unixhot.com")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"configmap/cmd-config created")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Mo=s("p",null,[s("strong",null,"查看ConfigMap")],-1),wo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl get configmap")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Lo=s("p",null,[s("strong",null,"查看ConfigMap内容")],-1),jo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl describe configmap cmd-config")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Events:  <none>")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Oo=s("p",null,[s("strong",null,"ConfigMap中包含多个键值对"),n(" 可以多次使用--from-literal为一个ConfigMap创建多个键值对，中间用空格分隔")],-1),Go=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl create configmap mcmd-config --from-literal=host=www.unixhot.com --from-literal=port=443 --from-literal=ssl=on")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"configmap/mcmd-config created")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Uo={id:"通过yaml文件创建configmap",tabindex:"-1"},Vo=s("p",null,"查看已创建的ConfigMap生成的YAML文件",-1),Ho=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl get configmap mcmd-config -o yaml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: v1")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"data:")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Yo=s("p",null,"只需要将metadata中无需指定的字段去掉即可生成一个YAML文件。",-1),Fo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl get configmap mcmd-config -o yaml > mcmd-config-v2.yaml")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  namespace: default")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Bo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl create -f mcmd-config-v2.yaml ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),$o={id:"通过文件创建configmap",tabindex:"-1"},qo=s("p",null,"ConfigMap除了可以存储单个或者多个键值对之外，可以存储完整的配置文件，将单个配置文件直接转换为ConfigMap在生产中十分常用",-1),Jo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl create configmap file-config --from-file=/etc/hosts")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"configmap/file-config created")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),zo=s("p",null,"可以看到ConfigMap直接存储了文件的内容，Key名称为文件名hosts，也可以手动指定Key的名称。",-1),Wo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl describe configmap file-config")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Events:  <none>")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Zo=s("p",null,"将Key手动指定为host-hosts",-1),Xo=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl create configmap file-config-v2 --from-file=host-hosts=/etc/hosts")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ot=s("p",null,"ConfigMap的内容可以通过环境变量的形成传递给容器，也可通过和Volume的形式挂载到容器中。",-1),tt={id:"通过环境变量给容器传递configmap",tabindex:"-1"},ct=s("p",null,"可以将ConfigMap中的键值对数据通过环境变量的形式传递到容器中，这样在配置容器的时候有一些数据可以使用环境变量，然后使用ConfigMap进行填充，这样就可以实现配置和Pod的分离。",-1),it={id:"_15-2-使用secret管理敏感数据",tabindex:"-1"},rt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"在应用启动过程中经常会有一些敏感信息需要存储，例如用户名和密码等，如果直接明文的方式保存会有安全风险。在Kubernetes中Secret这个资源对象类型用来保存敏感信息，例如密码、密钥、访问令牌、SSH Key等你认为需要保密的敏感信息。相对于将这些内容保存到容器镜像或者Pod的定义文件中，更加的灵活和安全。")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),pt={id:"配置pod使用harbor镜像",tabindex:"-1"},At=s("p",null,"1．docker login得到 docker密码文件",-1),dt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# docker login 192.168.56.11")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ct=s("p",null,"2.对密码文件进行加密",-1),ut=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cat /root/.docker/config.json |base64")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ht=s("p",null,"3.创建harbor使用的Secret YAML文件：",-1),yt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim harbor-secret.yaml ")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: v1")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Dt=s("p",null,"4.创建Secret",-1),gt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@jenkins k8s-deploy]# kubectl create -f reg-harbor.yaml ")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'secret "reg-harbor" created')]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),mt=s("p",null,"5.创建pod并挂载资源",-1),_t=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: v1")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"kind: Pod")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"metadata:")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    - name: harbor-secret")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),kt={id:"使用helm管理kubernetes应用",tabindex:"-1"},bt=s("p",null,"通过前面的学习，掌握了将应用迁移至Kubernetes的步骤和技巧，过程比较艰辛。例如我们创建一个应用，涉及到Deployment、Service、Ingress、PV、PVC，如何有效的管理这些资源呢，Kubernetes给出了一个最佳实践就是Helm。 Helm是一个kubernetes应用的包管理工具，用来管理charts——预先配置好的安装包资源，有点类似于Ubuntu的APT和CentOS中的yum。 Helm chart是用来封装kubernetes原生应用程序的yaml文件，可以在你部署应用的时候自定义应用程序的一些metadata，便与应用程序的分发。",-1),ft=s("p",null,"Helm和charts的主要作用：",-1),vt=s("ul",null,[s("li",null,"应用程序封装"),s("li",null,"版本管理"),s("li",null,"依赖检查"),s("li",null,"便于应用程序分发")],-1),xt={id:"helm部署",tabindex:"-1"},Pt={id:"安装helm",tabindex:"-1"},St=s("p",null,"1.部署Helm客户端",-1),Et=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cd /usr/local/src")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Nt=s("p",null,"2.验证安装是否成功",-1),Rt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm version")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Tt={id:"使用helm部署第一个应用",tabindex:"-1"},Kt=s("p",null,"4.搜索Helm应用",-1),It=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm search jenkins")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Mt=s("p",null,"5.查看仓库",-1),wt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm repo list")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Lt=s("p",null,"6.安装第一个应用",-1),jt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm install stable/jenkins")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ot={id:"_15-2-深入理解helm",tabindex:"-1"},Gt={id:"helm组件",tabindex:"-1"},Ut=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# tree ~/.helm/")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Vt=s("p",null,"默认缓存的文件",-1),Ht=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cd .helm/cache/archive/")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Yt={id:"自定义jenkins的chart",tabindex:"-1"},Ft=s("p",null,"修改为NodePort",-1),Bt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 jenkins]# vim values.yaml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"ServiceType: NodePort")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),$t=s("p",null,"检查",-1),qt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm lint ~/.helm/repository/local/jenkins/")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Jt=s("p",null,"查看有哪些应用",-1),zt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm list")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"For more information on running Jenkins on Kubernetes, visit:")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"https://cloud.google.com/solutions/jenkins-on-container-engine")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Wt=s("p",null,"查看状态",-1),Zt=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm status devops-jenkins")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Xt={id:"创建自己的chart",tabindex:"-1"},Qt={id:"创建自定义nginx的chart",tabindex:"-1"},sc=s("p",null,"1.创建自定义Chart Nginx的结构",-1),nc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm create helm-nginx")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ec=s("p",null,"2.编辑Chart配置",-1),lc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cd helm-nginx/")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 helm-nginx]# vim values.yaml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ac=s("p",null,"3.验证Chart配置，最后面的点表示当前目录",-1),oc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 helm-nginx]# helm install --dry-run --debug --name helm-nginx .")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),tc=s("p",null,"4.安装自定义Chart，最后面的点表示当前目录",-1),cc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 helm-nginx]# helm install --name helm-nginx .")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ic={id:"查看helm实例",tabindex:"-1"},rc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# helm list")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"NAME          REVISION    UPDATED                     STATUS      CHART                 NAMESPACE")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Kc=s("p",null,[s("strong",null,"Prometheus配置")],-1),Ic=s("p",null,"Prometheus的配置文件在prometheus.yml中，直接启动也会到命令的当前目录下寻找该文件。",-1),Mc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cd /usr/local/prometheus")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),wc=s("p",null,[s("strong",null,"启动Prometheus")],-1),Lc=s("p",null,'默认情况下Prometheus会把数据写在启动目录的./data目录下，可以通过启动参数指定目录：--storage.tsdb.path="data/"，更多参数可以通过—help查看',-1),jc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 prometheus]# ./prometheus –help")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Hc=s("p",null,"后台启动",-1),Yc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl enable prometheus")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl start prometheus")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Fc=s("p",null,"查看启动状态",-1),Bc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# netstat -ntlp | grep 9090")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"tcp6 0 0 :::9090 :::* LISTEN 61333/prometheus")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),$c={id:"使用node-exporter采集主机数据",tabindex:"-1"},qc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# cd /usr/local/src")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 src]# wget")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[Install]")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"WantedBy=multi-user.target")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Jc=s("p",null,"启动Node Exporter",-1),zc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl enable node_exporter")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl start node_exporter")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Wc=s("p",null,"查看状态 [root@linux-node1 ~]# netstat -ntlp | grep 9100",-1),Zc=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"tcp6 0 0 :::9100 :::* LISTEN 66239/node_exporter")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Xc=s("p",null,"默认情况下Node Exporter监听9100端口，通过/metrics暴露采集到的监控数据，Prometheus默认也从该地址获取数据。",-1),Qc=s("p",null,[s("img",{src:"http://k8s.unixhot.com/kubernetes/media/1004a69a33423c72a2989005be5a790e.png",alt:"img"})],-1),si=s("p",null,[s("strong",null,"配置Prometheus读取Node Exporter数据")],-1),ni=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim /usr/local/prometheus/prometheus.yml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"scrape_configs:")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"# The job name is added as a label `job=<job_name>` to any timeseries")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"scraped from this config.")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ei=s("p",null,[s("strong",null,"重启prometheus")],-1),li=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl restart prometheus")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ai=s("p",null,[s("strong",null,"查看监控状态")],-1),oi=s("p",null,"登录Prometheus的Web控制台，StatusTargets如果可以linux-node1并且状态是UP的状态即为配置成功。",-1),ti=s("p",null,[s("img",{src:"http://k8s.unixhot.com/kubernetes/media/8c3da60dbf5558dc649de1fd6ce43bf0.png",alt:"img"})],-1),ci={id:"使用prometheus-ui查看数据",tabindex:"-1"},ii={id:"使用grafana进行数据可视化",tabindex:"-1"},ri=s("p",null,[s("strong",null,"1.安装Grafana")],-1),pi=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim /etc/yum.repos.d/grafana.repo")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ai=s("p",null,[s("strong",null,"2.配置Grafana")],-1),di=s("p",null,"Grafana的配置文件在/etc/grafana/grafana.ini，默认情况下Grafana监听3000端口",-1),Ci=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim /etc/grafana/grafana.ini")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ui=s("p",null,[s("strong",null,"3.启动Grafana")],-1),hi=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# systemctl enable grafana-server")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ui=s("p",null,[s("strong",null,"创建角色")],-1),Vi=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim jenkins-role.yml")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Hi=s("p",null,[s("strong",null,"创建角色绑定")],-1),Yi=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# vim jenkins-role-binding.yml")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: rbac.authorization.k8s.io/v1")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  name: jenkins-role")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'  apiGroup: ""')]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Fi={id:"_22-深入理解pod调度",tabindex:"-1"},Bi={id:"深入理解pod调度",tabindex:"-1"},$i=s("p",null,"在前面的章节我们已经知道在Kubernetes中使用kube-scheduler进行Pod调度，它的目标是将Pod绑定到对应的Node上，经过一系列的条件和算法尽可能的让每个Pod都满意。kube-scheduler是Kubernetes默认的调度器。",-1),qi=s("p",null,"可以将代码克隆到本地方便查看",-1),Ji=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# git clone --depth 1 https://github.com/kubernetes/kubernetes.git")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),zi=s("p",null,"在algorithm下有调度算法，调度算法分为两个阶段：Predicates和priorities，首先对Node进行过滤看哪些Node符合调度要求，然后在符合调度要求的Node上进行优先级计算，判断调度到哪个Node最合适。",-1),Wi=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 algorithm]# pwd")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Zi=s("p",null,[s("strong",null,"设置调度器")],-1),Xi=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get pod kube-proxy-5wbtf -n kube-system -o yaml | grep schedulerName")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  schedulerName: default-scheduler")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Qi={id:"taints（污点）",tabindex:"-1"},sr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl describe node linux-node1.unixhot.com | grep Taints")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Taints:             node-role.kubernetes.io/master:NoSchedule")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),nr=s("p",null,"Taints的表现形式为",-1),er=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"<key>=<value>:<effect>")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),lr=s("p",null,"effect的三种类型：",-1),ar=s("ul",null,[s("li",null,"NoSchedule: 如果Pod没有容忍该污点，不调度到该节点上。"),s("li",null,"PreferNoSchedule：尽量阻止Pod被调度到这个节点上，但是如果没有其它节点能够调度，可以调度到该节点。"),s("li",null,"NoExecute： NoScheduler和PreferNoSchedule只是在调度阶段起作用，但是NoExecute会影响正常运行的Pod，如果一个节点被打了NoExecute的污点，而运行在该节点的Pod没有容忍会直接被这个节点移除。")],-1),or=s("p",null,"查看Flannel为何能调度到Master节点",-1),tr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl get po -n kube-system | grep flannel")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),cr={id:"自定义污点",tabindex:"-1"},ir=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@linux-node1 ~]# kubectl taint node linux-node2.example.com node-ytpe=gpu:NoSchedule       ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),rr={id:"亲缘性调度",tabindex:"-1"},pr={id:"_23-kubernetes-api介绍",tabindex:"-1"},Ar=s("p",null,"查看集群状态",-1),dr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl cluster-info")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Cr=s("p",null,"直接访问Kubernetes API需要验证，无法直接访问。",-1),ur=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# curl -k https://192.168.56.11:6443")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"}")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),hr=s("p",null,[s("strong",null,"通过Proxy访问Kubernetes API")],-1),yr=s("p",null,"使用kubectl proxy可以在Master本地启动一个代理",-1),Dr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl proxy")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Starting to serve on 127.0.0.1:8001")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),gr=s("p",null,"可以通过127.0.0.1:8001与API Server进行交互",-1),mr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# curl http://127.0.0.1:8001")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),_r=s("p",null,"可以通过修改监听地址，并关闭过滤，实现在其它地方登录和查看，这样就可以在本地浏览器访问API。切记不要再生产环境将代理地址暴露在外网。",-1),kr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl proxy --address=0.0.0.0 --disable-filter=true")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),br={id:"使用swagger-ui进行api交互",tabindex:"-1"},fr=s("p",null,"Kubernetes支持Swagger UI访问API，需要在API Server开启，如果已经根据本书使用kubeadm部署的集群，可以通过修改Pod的YAML文件，重建Pod来开启",-1),vr=s("p",null,[s("strong",null,"修改API Server的Pod定义文件")],-1),xr=s("p",null,"在- kube-apiserver下面一行增加--enable-swagger-ui=true",-1),Pr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# vim /etc/kubernetes/manifests/kube-apiserver.yaml ")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"apiVersion: v1")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"kind: Pod")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"metadata:")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Sr=s("p",null,"删除Pod，kubelet会通过该YAML重建Pod",-1),Er=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl get pod -n kube-system | grep api")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Nr=s("p",null,"可以看到配置已经生效",-1),Rr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl describe pod kube-apiserver-linux-node1.unixhot.com -n kube-system ")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"...")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    Command:")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      kube-apiserver")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      --enable-swagger-ui=true")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"....")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Tr=s("p",null,"部署一个Swagger UI服务查看API",-1),Kr=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@k8s-master1 ~]# kubectl run swagger-ui --image=swaggerapi/swagger-ui:latest")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ir=s("p",null,"因为我们部署的Swagger UI和API Server不在一个域名下，所以会有跨域的问题，Chrome浏览器需要提前安装Allow CROS插件解决",-1),Mr=s("hr",null,null,-1),wr=s("hr",null,null,-1),Lr=s("p",null,"摘录自赵班长--------",-1);function jr(o,Or,Gr,Ur,i,Vr){const l=u,r=p;return C(),d(r,{frontmatter:i.frontmatter,data:i.data},{"main-content-md":e(()=>[s("h1",D,[n("Kubernetes快速入门 "),a(l,{class:"header-anchor",href:"#kubernetes快速入门","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),g,s("ul",null,[s("li",null,[n("Kubernetes官方文档："),a(l,{href:"https://kubernetes.io/docs/home/",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("https://kubernetes.io/docs/home/")]),_:1})]),s("li",null,[n("Kuernetes Github："),a(l,{href:"https://github.com/kubernetes/",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("https://github.com/kubernetes/")]),_:1})])]),s("h2",m,[n("Kubernetes架构介绍 "),a(l,{class:"header-anchor",href:"#kubernetes架构介绍","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),_,s("h3",k,[n("Kubernetes系统架构 "),a(l,{class:"header-anchor",href:"#kubernetes系统架构","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),b,f,v,x,P,S,E,N,R,T,s("h3",K,[n("Kubernetes逻辑架构 "),a(l,{class:"header-anchor",href:"#kubernetes逻辑架构","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),I,M,w,L,j,O,G,U,V,H,Y,F,s("h3",B,[n("Kubernetes网络介绍 "),a(l,{class:"header-anchor",href:"#kubernetes网络介绍","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),$,q,J,z,W,Z,X,Q,ss,ns,s("h2",es,[n("使用kubeadm部署Kubernetes v1.16.4 "),a(l,{class:"header-anchor",href:"#使用kubeadm部署kubernetes-v1-16-4","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ls,as,os,ts,cs,s("table",null,[is,s("tbody",null,[s("tr",null,[s("td",null,[a(l,{href:"http://linux-node1.linuxhot.com",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("linux-node1.linuxhot.com")]),_:1})]),rs,ps,As]),s("tr",null,[s("td",null,[a(l,{href:"http://linux-node2.linuxhot.com",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("linux-node2.linuxhot.com")]),_:1})]),ds,Cs,us]),s("tr",null,[s("td",null,[a(l,{href:"http://linux-node3.linuxhot.com",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("linux-node3.linuxhot.com")]),_:1})]),hs,ys,Ds]),gs,ms,_s])]),s("h3",ks,[n("部署Docker "),a(l,{class:"header-anchor",href:"#部署docker","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),bs,fs,vs,xs,s("p",null,[n("由于kubeadm对Docker的版本是有要求的，需要安装与Kubernetes匹配的版本，这个对应关系一般在每次发布的Changlog中可以找到，例如1.16.2的CHANGELOG如下："),a(l,{href:"https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG-1.16.md",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("CHANGELOG")]),_:1})]),Ps,Ss,Es,Ns,Rs,Ts,Ks,Is,Ms,ws,s("h3",Ls,[n("部署kubadm和kubelet "),a(l,{class:"header-anchor",href:"#部署kubadm和kubelet","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),js,Os,Gs,Us,Vs,Hs,Ys,Fs,Bs,$s,qs,Js,zs,Ws,Zs,Xs,Qs,sn,nn,en,ln,an,on,tn,cn,s("ul",null,[s("li",null,[n("以上步骤请在Kubernetes的所有节点上执行，本实验环境是需要在linux-node1、linux-node2、linux-node3这三台机器上均安装Docker、kubeadm、kubelet，对于以上操作需要自动化可以参考我使用SaltStack完成的salt-kubeadm项目："),a(l,{href:"https://github.com/unixhot/salt-kubeadm",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("https://github.com/unixhot/salt-kubeadm")]),_:1})])]),s("h3",rn,[n("初始化集群部署Master "),a(l,{class:"header-anchor",href:"#初始化集群部署master","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),pn,An,dn,Cn,un,hn,yn,Dn,gn,mn,_n,kn,bn,fn,vn,xn,Pn,Sn,En,Nn,Rn,Tn,Kn,In,Mn,wn,Ln,jn,On,s("h3",Gn,[n("部署网络插件 "),a(l,{class:"header-anchor",href:"#部署网络插件","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Un,Vn,Hn,Yn,Fn,Bn,$n,qn,Jn,zn,Wn,Zn,s("h3",Xn,[n("部署Node节点 "),a(l,{class:"header-anchor",href:"#部署node节点","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Qn,se,ne,ee,le,ae,oe,te,ce,ie,re,pe,Ae,s("p",null,[de,n(" `` [root@linux-node1 ~]# kubectl get node NAME STATUS ROLES AGE VERSION "),a(l,{href:"http://linux-node1.linuxhot.com",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("linux-node1.linuxhot.com")]),_:1}),n(" Ready master 49m v1.13.2 "),a(l,{href:"http://linux-node2.linuxhot.com",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("linux-node2.linuxhot.com")]),_:1}),n(" Ready 4m48s v1.13.2")]),Ce,ue,he,ye,s("h2",De,[n("公有云中的Kubernetes "),a(l,{class:"header-anchor",href:"#公有云中的kubernetes","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ge,s("h3",me,[n("阿里云中的Kubernetes "),a(l,{class:"header-anchor",href:"#阿里云中的kubernetes","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),_e,ke,be,fe,ve,xe,Pe,Se,Ee,Ne,Re,Te,s("h3",Ke,[n("私有云中的Kubernetes "),a(l,{class:"header-anchor",href:"#私有云中的kubernetes","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ie,Me,we,Le,je,s("h1",Oe,[n("第五部分 将应用迁移至Kubernetes "),a(l,{class:"header-anchor",href:"#第五部分-将应用迁移至kubernetes","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Ge,[n("6 第一步：将应用封装进容器中 "),a(l,{class:"header-anchor",href:"#_6-第一步：将应用封装进容器中","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h2",Ue,[n("第一步：将应用封装进容器中 "),a(l,{class:"header-anchor",href:"#第一步：将应用封装进容器中","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ve,s("h3",He,[n("部署Harbor镜像仓库 "),a(l,{class:"header-anchor",href:"#部署harbor镜像仓库","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ye,Fe,s("h3",Be,[n("制作实验用的Docker镜像 "),a(l,{class:"header-anchor",href:"#制作实验用的docker镜像","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),$e,qe,s("h3",Je,[n("配置Docker仓库 "),a(l,{class:"header-anchor",href:"#配置docker仓库","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ze,s("h3",We,[n("登录Harbor镜像仓库 "),a(l,{class:"header-anchor",href:"#登录harbor镜像仓库","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ze,s("h3",Xe,[n("提交镜像到Registry "),a(l,{class:"header-anchor",href:"#提交镜像到registry","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Qe,sl,s("h1",nl,[n("7 第二步：将容器封装到Pod中 "),a(l,{class:"header-anchor",href:"#_7-第二步：将容器封装到pod中","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),el,ll,al,s("h2",ol,[n("Pod管理 "),a(l,{class:"header-anchor",href:"#pod管理","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),tl,cl,il,rl,pl,Al,dl,Cl,ul,hl,yl,Dl,gl,ml,_l,kl,bl,s("h1",fl,[n("7.3 第三步：使用Controllers管理Pod "),a(l,{class:"header-anchor",href:"#_7-3-第三步：使用controllers管理pod","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),vl,s("h1",xl,[n("8.1 Replication Controller控制器 "),a(l,{class:"header-anchor",href:"#_8-1-replication-controller控制器","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Pl,[n("8.2 Replica Sets控制器 "),a(l,{class:"header-anchor",href:"#_8-2-replica-sets控制器","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Sl,[n("8.3 Deployment控制器 "),a(l,{class:"header-anchor",href:"#_8-3-deployment控制器","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",El,[n("8.4 DaemonSet控制器 "),a(l,{class:"header-anchor",href:"#_8-4-daemonset控制器","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Nl,Rl,Tl,Kl,Il,Ml,wl,s("h1",Ll,[n("7.4 第四步：使用Service管理Pod访问 "),a(l,{class:"header-anchor",href:"#_7-4-第四步：使用service管理pod访问","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),jl,s("h1",Ol,[n("9.1 Service介绍和管理 "),a(l,{class:"header-anchor",href:"#_9-1-service介绍和管理","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",Gl,[n("创建Service "),a(l,{class:"header-anchor",href:"#创建service","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ul,Vl,Hl,Yl,Fl,Bl,$l,ql,Jl,s("h1",zl,[n("9.2 Service和Endpoint "),a(l,{class:"header-anchor",href:"#_9-2-service和endpoint","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Wl,Zl,Xl,s("h3",Ql,[n("创建一个Headless Service "),a(l,{class:"header-anchor",href:"#创建一个headless-service","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),sa,na,ea,la,aa,oa,ta,ca,s("h1",ia,[n("7.5 第五步：使用Ingress提供外部访问 "),a(l,{class:"header-anchor",href:"#_7-5-第五步：使用ingress提供外部访问","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ra,pa,s("h2",Aa,[n("10.1 Ingress Controller "),a(l,{class:"header-anchor",href:"#_10-1-ingress-controller","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),da,Ca,ua,s("h2",ha,[n("Ingress Controller Traefik "),a(l,{class:"header-anchor",href:"#ingress-controller-traefik","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",ya,[n("部署Treafik "),a(l,{class:"header-anchor",href:"#部署treafik","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Da,s("h1",ga,[n("11 第六步：使用PV和PVC管理数据存储 "),a(l,{class:"header-anchor",href:"#_11-第六步：使用pv和pvc管理数据存储","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ma,s("h1",_a,[n("11.1 Kubernetes Volume "),a(l,{class:"header-anchor",href:"#_11-1-kubernetes-volume","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",ka,[n("11.2 PersistentVolume（PV） "),a(l,{class:"header-anchor",href:"#_11-2-persistentvolume（pv）","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ba,fa,va,xa,Pa,Sa,Ea,Na,Ra,s("h1",Ta,[n("11.3 PersistentVolumeClaim（PVC） "),a(l,{class:"header-anchor",href:"#_11-3-persistentvolumeclaim（pvc）","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ka,Ia,Ma,wa,La,ja,Oa,s("h1",Ga,[n("11.4 StorageClass "),a(l,{class:"header-anchor",href:"#_11-4-storageclass","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Ua,[n("7 第七步：使用Rancher管理Kubernetes集群 "),a(l,{class:"header-anchor",href:"#_7-第七步：使用rancher管理kubernetes集群","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Va,s("h2",Ha,[n("7.1 Rancher快速入门 "),a(l,{class:"header-anchor",href:"#_7-1-rancher快速入门","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ya,Fa,s("h2",Ba,[n("7.2 使用Rancher进行日常管理 "),a(l,{class:"header-anchor",href:"#_7-2-使用rancher进行日常管理","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h2",$a,[n("7.3 Rancher生产集群部署 "),a(l,{class:"header-anchor",href:"#_7-3-rancher生产集群部署","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",qa,[n("第六部分 管理Kubernetes中的应用 "),a(l,{class:"header-anchor",href:"#第六部分-管理kubernetes中的应用","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Ja,[n("13 应用的资源限制和健康检查 "),a(l,{class:"header-anchor",href:"#_13-应用的资源限制和健康检查","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",za,[n("13.1 应用的资源限制 "),a(l,{class:"header-anchor",href:"#_13-1-应用的资源限制","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Wa,[n("13.2 应用的健康检查 "),a(l,{class:"header-anchor",href:"#_13-2-应用的健康检查","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",Za,[n("Liveness探测 "),a(l,{class:"header-anchor",href:"#liveness探测","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Xa,Qa,s("h3",so,[n("Readiness探测 "),a(l,{class:"header-anchor",href:"#readiness探测","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),no,s("h2",eo,[n("健康检查的方法 "),a(l,{class:"header-anchor",href:"#健康检查的方法","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),lo,ao,oo,s("ul",null,[to,co,io,ro,po,Ao,Co,s("li",null,[uo,s("h1",ho,[n("管理应用的DNS访问 "),a(l,{class:"header-anchor",href:"#管理应用的dns访问","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})])])]),s("h1",yo,[a(l,{href:"http://k8s.unixhot.com/",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("14.1 Kubernetes中的DNS")]),_:1}),n(),a(l,{class:"header-anchor",href:"#_14-1-kubernetes中的dns","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Do,[n("应用的DNS管理 "),a(l,{class:"header-anchor",href:"#应用的dns管理","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",go,[n("Pod的域名解析策略 "),a(l,{class:"header-anchor",href:"#pod的域名解析策略","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),mo,_o,ko,bo,fo,vo,xo,Po,So,Eo,s("h2",No,[n("应用的DNS管理 "),a(l,{class:"header-anchor",href:"#应用的dns管理-1","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h2",Ro,[n("15.1 使用ConfigMap管理应用配置 "),a(l,{class:"header-anchor",href:"#_15-1-使用configmap管理应用配置","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",To,[n("通过kubectl命令创建ConfigMap "),a(l,{class:"header-anchor",href:"#通过kubectl命令创建configmap","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ko,Io,Mo,wo,Lo,jo,Oo,Go,s("h3",Uo,[n("通过YAML文件创建ConfigMap "),a(l,{class:"header-anchor",href:"#通过yaml文件创建configmap","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Vo,Ho,Yo,Fo,s("p",null,[a(l,{href:"http://xn--metadata-0n3mp82lcujlhxj58f8qvb.name",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("注意需要修改metadata.name")]),_:1}),n(",修改完毕后直接创建即可")]),Bo,s("h3",$o,[n("通过文件创建ConfigMap "),a(l,{class:"header-anchor",href:"#通过文件创建configmap","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),qo,Jo,zo,Wo,Zo,Xo,s("h3",Qo,[n("从目录创建ConfigMap "),a(l,{class:"header-anchor",href:"#从目录创建configmap","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),st,nt,s("h3",et,[n("混合选项创建ConfigMap "),a(l,{class:"header-anchor",href:"#混合选项创建configmap","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),lt,at,ot,s("h3",tt,[n("通过环境变量给容器传递ConfigMap "),a(l,{class:"header-anchor",href:"#通过环境变量给容器传递configmap","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ct,s("h2",it,[n("15.2 使用Secret管理敏感数据 "),a(l,{class:"header-anchor",href:"#_15-2-使用secret管理敏感数据","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),rt,s("h3",pt,[n("配置Pod使用Harbor镜像 "),a(l,{class:"header-anchor",href:"#配置pod使用harbor镜像","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),At,dt,Ct,ut,ht,yt,Dt,gt,mt,_t,s("h1",kt,[n("使用Helm管理Kubernetes应用 "),a(l,{class:"header-anchor",href:"#使用helm管理kubernetes应用","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),bt,ft,vt,s("h2",xt,[n("Helm部署 "),a(l,{class:"header-anchor",href:"#helm部署","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",Pt,[n("安装Helm "),a(l,{class:"header-anchor",href:"#安装helm","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),St,Et,Nt,Rt,s("h3",Tt,[n("使用Helm部署第一个应用 "),a(l,{class:"header-anchor",href:"#使用helm部署第一个应用","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Kt,It,Mt,wt,Lt,jt,s("h1",Ot,[n("15.2 深入理解Helm "),a(l,{class:"header-anchor",href:"#_15-2-深入理解helm","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",Gt,[n("Helm组件 "),a(l,{class:"header-anchor",href:"#helm组件","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ut,Vt,Ht,s("h3",Yt,[n("自定义Jenkins的Chart "),a(l,{class:"header-anchor",href:"#自定义jenkins的chart","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ft,Bt,$t,qt,Jt,zt,Wt,Zt,s("h2",Xt,[n("创建自己的Chart "),a(l,{class:"header-anchor",href:"#创建自己的chart","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",Qt,[n("创建自定义Nginx的Chart "),a(l,{class:"header-anchor",href:"#创建自定义nginx的chart","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),sc,nc,ec,lc,ac,oc,tc,cc,s("h3",ic,[n("查看Helm实例 "),a(l,{class:"header-anchor",href:"#查看helm实例","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),rc,s("h1",pc,[n("17 应用的日志采集与分析 "),a(l,{class:"header-anchor",href:"#_17-应用的日志采集与分析","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h2",Ac,[n("Prometheus快速入门 "),a(l,{class:"header-anchor",href:"#prometheus快速入门","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h3",dc,[n("Prometheus架构介绍 "),a(l,{class:"header-anchor",href:"#prometheus架构介绍","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Cc,uc,hc,yc,Dc,gc,mc,_c,kc,bc,fc,vc,xc,Pc,Sc,s("h3",Ec,[n("安装Prometheus "),a(l,{class:"header-anchor",href:"#安装prometheus","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Nc,Rc,s("p",null,[n("为了方便学习，首先我们使用二进制方式部署，可以在这里"),a(l,{href:"https://prometheus.io/download/%E4%B8%8B%E8%BD%BD%E5%AF%B9%E5%BA%94%E7%9A%84%E9%A2%84%E7%BC%96%E8%AF%91%E7%9A%84%E4%BA%8C%E8%BF%9B%E5%88%B6%E6%96%87%E4%BB%B6%E3%80%82",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("https://prometheus.io/download/下载对应的预编译的二进制文件。")]),_:1})]),Tc,Kc,Ic,Mc,wc,Lc,jc,Oc,Gc,Uc,Vc,Hc,Yc,Fc,Bc,s("h3",$c,[n("使用Node Exporter采集主机数据 "),a(l,{class:"header-anchor",href:"#使用node-exporter采集主机数据","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),qc,Jc,zc,Wc,Zc,Xc,Qc,si,ni,ei,li,ai,oi,ti,s("h3",ci,[n("使用Prometheus UI查看数据 "),a(l,{class:"header-anchor",href:"#使用prometheus-ui查看数据","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("p",null,[n("现在Prometheus会定期的从"),a(l,{href:"http://192.168.56.11:9100/metrics%E8%8E%B7%E5%8F%96%E6%95%B0%E6%8D%AE%EF%BC%8C%E5%B9%B6%E5%AD%98%E5%82%A8%EF%BC%8C%E6%88%91%E4%BB%AC%E5%8F%AF%E4%BB%A5%E4%BD%BF%E7%94%A8Prometheus",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("http://192.168.56.11:9100/metrics获取数据，并存储，我们可以使用Prometheus")]),_:1}),n(" UI来查看监控数据。")]),s("h3",ii,[n("使用Grafana进行数据可视化 "),a(l,{class:"header-anchor",href:"#使用grafana进行数据可视化","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ri,pi,Ai,di,Ci,ui,hi,yi,s("p",null,[n("访问"),a(l,{href:"http://192.168.56.11:3000/",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("http://192.168.56.11:3000")]),_:1}),n("，用户名和密码默认为admin/admin，第一次登陆会要求修改密码，请使用安全密码。")]),Di,gi,mi,_i,ki,bi,s("p",null,[n("配置URL为："),a(l,{href:"http://192.168.56.11:9090/",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("http://192.168.56.11:9090")]),_:1}),n("，并点击Save&Test。")]),fi,vi,xi,s("p",null,[n("下载地址："),a(l,{href:"https://grafana.com/dashboards/405%EF%BC%8C%E5%9C%A8%E5%8F%B3%E4%BE%A7%E6%9C%89Download",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("https://grafana.com/dashboards/405，在右侧有Download")]),_:1}),n(" Json按钮，下载该Json文件。")]),Pi,Si,Ei,Ni,Ri,Ti,Ki,s("h1",Ii,[n("第七部分 Kubernetes高级进阶 "),a(l,{class:"header-anchor",href:"#第七部分-kubernetes高级进阶","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Mi,[n("Kubernetes的权限控制RBAC "),a(l,{class:"header-anchor",href:"#kubernetes的权限控制rbac","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),wi,Li,ji,Oi,Gi,Ui,Vi,Hi,Yi,s("h1",Fi,[n("22 深入理解Pod调度 "),a(l,{class:"header-anchor",href:"#_22-深入理解pod调度","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",Bi,[n("深入理解Pod调度 "),a(l,{class:"header-anchor",href:"#深入理解pod调度","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),$i,s("p",null,[n("kube-scheduler的代码位于"),a(l,{href:"https://github.com/kubernetes/kubernetes/tree/master/pkg/scheduler",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("GitHub")]),_:1})]),qi,Ji,zi,Wi,s("p",null,[n("官方文档详细的介绍了所有的步骤："),a(l,{href:"https://kubernetes.io/docs/concepts/scheduling/kube-scheduler/",target:"_blank",rel:"noreferrer"},{default:e(()=>[n("https://kubernetes.io/docs/concepts/scheduling/kube-scheduler/")]),_:1})]),Zi,Xi,s("h2",Qi,[n("Taints（污点） "),a(l,{class:"header-anchor",href:"#taints（污点）","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),sr,nr,er,lr,ar,or,tr,s("h3",cr,[n("自定义污点 "),a(l,{class:"header-anchor",href:"#自定义污点","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),ir,s("h2",rr,[n("亲缘性调度 "),a(l,{class:"header-anchor",href:"#亲缘性调度","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),s("h1",pr,[n("23 Kubernetes API介绍 "),a(l,{class:"header-anchor",href:"#_23-kubernetes-api介绍","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),Ar,dr,Cr,ur,hr,yr,Dr,gr,mr,_r,kr,s("h3",br,[n("使用Swagger UI进行API交互 "),a(l,{class:"header-anchor",href:"#使用swagger-ui进行api交互","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),fr,vr,xr,Pr,Sr,Er,Nr,Rr,Tr,Kr,Ir,Mr,wr,Lr]),"main-header":e(()=>[t(o.$slots,"main-header")]),"main-header-after":e(()=>[t(o.$slots,"main-header-after")]),"main-nav":e(()=>[t(o.$slots,"main-nav")]),"main-content":e(()=>[t(o.$slots,"main-content")]),"main-content-after":e(()=>[t(o.$slots,"main-content-after")]),"main-nav-before":e(()=>[t(o.$slots,"main-nav-before")]),"main-nav-after":e(()=>[t(o.$slots,"main-nav-after")]),comment:e(()=>[t(o.$slots,"comment")]),footer:e(()=>[t(o.$slots,"footer")]),aside:e(()=>[t(o.$slots,"aside")]),"aside-custom":e(()=>[t(o.$slots,"aside-custom")]),default:e(()=>[t(o.$slots,"default")]),_:3},8,["frontmatter","data"])}const Jr=A(y,[["render",jr]]);export{qr as __pageData,Jr as default};
