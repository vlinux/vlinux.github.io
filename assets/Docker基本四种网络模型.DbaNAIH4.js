import{_ as m}from"./ValaxyMain.vue_vue_type_style_index_0_lang.DBuGQqdy.js";import"./chunks/@vueuse/motion.BITvz5PP.js";import{e as f,u as k,a as b}from"./chunks/vue-router.BxaDuBsg.js";import{aa as h,ap as a,ag as l,af as n,ai as s,P as g,ab as v,a1 as T}from"./framework.GHZxz7jq.js";import"./index.DpUV-Spk.js";import"./chunks/dayjs.BldX5ftQ.js";import"./chunks/vue-i18n.C7V8WoQZ.js";import"./chunks/pinia.BfAlK2F6.js";import"./chunks/nprogress.BZwbcB2O.js";/* empty css                    */import"./YunComment.vue_vue_type_style_index_0_lang.MEbNDp3K.js";import"./index.C5okkQwF.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang.fblE3Fel.js";import"./post.CjbzLuOT.js";const N=f("/posts/Docker基本四种网络模型",async t=>JSON.parse('{"title":"Docker基本四种网络模型","description":"","frontmatter":{"title":"Docker基本四种网络模型","categories":"DevOps","tags":["Docker"],"date":"2020-06-23 16:40:00"},"headers":[],"relativePath":"pages/posts/Docker基本四种网络模型.md","lastUpdated":null}'),{lazy:(t,o)=>t.name===o.name}),x={__name:"Docker基本四种网络模型",setup(t,{expose:o}){const{data:p}=N(),c=b(),u=k(),r=Object.assign(u.meta.frontmatter||{},p.value?.frontmatter||{});return c.currentRoute.value.data=p.value,T("valaxy:frontmatter",r),globalThis.$frontmatter=r,o({frontmatter:{title:"Docker基本四种网络模型",categories:"DevOps",tags:["Docker"],date:"2020-06-23 16:40:00"}}),(e,i)=>{const d=m;return v(),h(d,{frontmatter:g(r)},{"main-content-md":a(()=>[...i[0]||(i[0]=[n("h3",{id:"一-nat-最小",tabindex:"-1"},[s("一，NAT（最小） "),n("a",{class:"header-anchor",href:"#一-nat-最小","aria-label":'Permalink to "一，NAT（最小）"'},"​")],-1),n("div",{class:"language-"},[n("button",{title:"Copy code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code"},[n("code",{"v-pre":""},[n("span",{class:"line"},[n("span",null,"NAT网络模型，默认情况下，均为NAT模式，如网络的端口映射就为NAT")])])]),n("button",{class:"code-block-unfold-btn"})],-1),n("h3",{id:"二-none",tabindex:"-1"},[s("二，none "),n("a",{class:"header-anchor",href:"#二-none","aria-label":'Permalink to "二，none"'},"​")],-1),n("div",{class:"language-"},[n("button",{title:"Copy code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code"},[n("code",{"v-pre":""},[n("span",{class:"line"},[n("span",null,"格式：docker run --net=none")]),s(`
