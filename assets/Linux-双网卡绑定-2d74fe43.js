...
`)],-1),w={id:"bond-模式-nmcli命令行实现双网卡绑定",tabindex:"-1"},M=n("strong",null,"bond 模式 nmcli命令行实现双网卡绑定",-1),G={id:"注意：",tabindex:"-1"},J=n("p",null,[n("code",null,"必须保证服务器有两块同网段网卡设备"),n("strong",null,"环境：")],-1),Z=n("ul",null,[n("li",null,"已添加 网卡1 ens33"),n("li",null,"已添加 网卡2 ens34")],-1),F=n("p",null,[n("strong",null,"1、创建Master配置文件")],-1),W=n("pre",null,[n("code",null,`# nmcli connection add type bond con-name 设备名称 ifname 设备名称 mode 模式号 miimon 毫秒
nmcli connection add type bond con-name bond6 ifname bond6 mode 1 miimon 100
`)],-1),X=n("p",null,[n("code",null,"注：miimon：指定当发现一个链路恢复时，在激活该链路之前的等待时间，以毫秒计算")],-1),Y=n("p",null,[n("strong",null,"2、新建Slave1配置文件")],-1),j=n("pre",null,[n("code",null,`# nmcli connection add type bond-slave ifname 设备名称 master master设备名称
nmcli connection add type bond-slave ifname ens33 master bond6
`)],-1),q=n("p",null,[n("strong",null,"3、新建Slave2配置文件")],-1),z=n("pre",null,[n("code",null,`# nmcli connection add type bond-slave ifname 设备名称 master master设备名称
...
`)],-1),en=n("p",null,"[player id='712292593' type='collect' autoplay='true'/]",-1);function on(o,tn,ln,sn,d,an){const s=h,c=r;return _(),m(c,{frontmatter:d.frontmatter,data:d.data},{"main-content-md":e(()=>[n("h1",g,[l("Linux 双网卡绑定 "),a(s,{class:"header-anchor",href:"#linux-双网卡绑定","aria-hidden":"true"},{default:e(()=>[l("#")]),_:1})]),v,x,L,S,E,n("h2",y,[l("bond 模式 修改配置文件实现双网卡绑定 "),a(s,{class:"header-anchor",href:"#bond-模式-修改配置文件实现双网卡绑定","aria-hidden":"true"},{default:e(()=>[l("#")]),_:1})]),O,$,T,k,D,N,V,A,P,R,I,B,C,U,n("h2",w,[M,l(),a(s,{class:"header-anchor",href:"#bond-模式-nmcli命令行实现双网卡绑定","aria-hidden":"true"},{default:e(()=>[l("#")]),_:1})]),n("h2",G,[l("注意： "),a(s,{class:"header-anchor",href:"#注意：","aria-hidden":"true"},{default:e(()=>[l("#")]),_:1})]),J,Z,F,W,X,Y,j,q,z,H,K,Q,nn,p("more"),en]),"main-header":e(()=>[t(o.$slots,"main-header")]),"main-header-after":e(()=>[t(o.$slots,"main-header-after")]),"main-nav":e(()=>[t(o.$slots,"main-nav")]),"main-content":e(()=>[t(o.$slots,"main-content")]),"main-content-after":e(()=>[t(o.$slots,"main-content-after")]),"main-nav-before":e(()=>[t(o.$slots,"main-nav-before")]),"main-nav-after":e(()=>[t(o.$slots,"main-nav-after")]),comment:e(()=>[t(o.$slots,"comment")]),footer:e(()=>[t(o.$slots,"footer")]),aside:e(()=>[t(o.$slots,"aside")]),"aside-custom":e(()=>[t(o.$slots,"aside-custom")]),default:e(()=>[t(o.$slots,"default")]),_:3},8,["frontmatter","data"])}const pn=u(f,[["render",on]]);export{_n as __pageData,pn as default};
