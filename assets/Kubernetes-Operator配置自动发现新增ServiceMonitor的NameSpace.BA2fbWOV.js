import{_ as d}from"./ValaxyMain.vue_vue_type_style_index_0_lang.DBuGQqdy.js";import"./chunks/@vueuse/motion.BITvz5PP.js";import{e as h,u as b,a as g}from"./chunks/vue-router.BxaDuBsg.js";import{aa as v,ap as a,ag as e,af as n,ai as s,P as k,ab as f,a1 as S}from"./framework.GHZxz7jq.js";import"./index.DpUV-Spk.js";import"./chunks/dayjs.BldX5ftQ.js";import"./chunks/vue-i18n.C7V8WoQZ.js";import"./chunks/pinia.BfAlK2F6.js";import"./chunks/nprogress.BZwbcB2O.js";/* empty css                    */import"./YunComment.vue_vue_type_style_index_0_lang.MEbNDp3K.js";import"./index.C5okkQwF.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang.fblE3Fel.js";import"./post.CjbzLuOT.js";const M=h("/posts/Kubernetes-Operator配置自动发现新增ServiceMonitor的NameSpace",async p=>JSON.parse('{"title":"Kubernetes-Operator配置自动发现新增ServiceMonitor的NameSpace","description":"","frontmatter":{"title":"Kubernetes-Operator配置自动发现新增ServiceMonitor的NameSpace","categories":"Prometheus","tags":["kube-prometheus","Prometheus-Operator"],"date":"2022-01-29 14:26:32"},"headers":[],"relativePath":"pages/posts/Kubernetes-Operator配置自动发现新增ServiceMonitor的NameSpace.md","lastUpdated":null}'),{lazy:(p,i)=>p.name===i.name}),Y={__name:"Kubernetes-Operator配置自动发现新增ServiceMonitor的NameSpace",setup(p,{expose:i}){const{data:c}=M(),r=g(),u=b(),t=Object.assign(u.meta.frontmatter||{},c.value?.frontmatter||{});return r.currentRoute.value.data=c.value,S("valaxy:frontmatter",t),globalThis.$frontmatter=t,i({frontmatter:{title:"Kubernetes-Operator配置自动发现新增ServiceMonitor的NameSpace",categories:"Prometheus",tags:["kube-prometheus","Prometheus-Operator"],date:"2022-01-29 14:26:32"}}),(l,o)=>{const m=d;return f(),v(m,{frontmatter:k(t)},{"main-content-md":a(()=>[...o[0]||(o[0]=[n("blockquote",null,[n("p",null,[s("最近在监控k8s当中的Jenkins 的时候,新增ServiceMonitor总是不显示,这里的不显示指的是不在Prometheus-Operator中显示,我认为这其中一定有问题,于是查阅了大量的资料,终于从中找到了答案, 原因竟是Prometheus-Operator在安装的时候默认只会自动发现"),n("code",null,"default"),s(","),n("code",null,"kube-system"),s(","),n("code",null,"monitoring"),s("这三个名称空间下新建的ServiceMonitor,而我的ServiceMonitor又是新建在别的名称空间下所以他无法进行自动发现")]),n("p",null,"更奇怪的是,网上对这个问题的记录文章几乎为0,我根本找不到,所以才写下这个笔记,供看到的人借鉴!")],-1),n("h2",{id:"_1-监控其他-namespace-中的-endpoint-资源",tabindex:"-1"},[s("1. 监控其他 namespace 中的 endpoint 资源 "),n("a",{class:"header-anchor",href:"#_1-监控其他-namespace-中的-endpoint-资源","aria-label":'Permalink to "1. 监控其他 namespace 中的 endpoint 资源"'},"​")],-1),n("p",null,"需要做的操作",-1),n("ol",null,[n("li",null,"创建新增命名空间的 role， 用于获取监控的信息。"),n("li",null,"将创建的role绑定到 monitoring 命名空间中的 prometheus-k8s SA。")],-1),n("div",{class:"language-"},[n("button",{title:"Copy code",class:"copy"}),n("span",{class:"lang"}),n("pre",{class:"shiki shiki-themes github-light github-dark vp-code"},[n("code",{"v-pre":""},[n("span",{class:"line"},[n("span",null,"kubectl create ns test")]),s(`
...
`),n("span",{class:"line"},[n("span",null,"    matchLabels:")]),s(`
`),n("span",{class:"line"},[n("span",null,"      app: ingress-demo-app")]),s(`
`),n("span",{class:"line"},[n("span",null,"EOF")])])]),n("button",{class:"code-block-unfold-btn"})],-1),n("p",null,"希望",-1)])]),"main-header":a(()=>[e(l.$slots,"main-header")]),"main-header-after":a(()=>[e(l.$slots,"main-header-after")]),"main-nav":a(()=>[e(l.$slots,"main-nav")]),"main-content-before":a(()=>[e(l.$slots,"main-content-before")]),"main-content":a(()=>[e(l.$slots,"main-content")]),"main-content-after":a(()=>[e(l.$slots,"main-content-after")]),"main-nav-before":a(()=>[e(l.$slots,"main-nav-before")]),"main-nav-after":a(()=>[e(l.$slots,"main-nav-after")]),comment:a(()=>[e(l.$slots,"comment")]),footer:a(()=>[e(l.$slots,"footer")]),aside:a(()=>[e(l.$slots,"aside")]),"aside-custom":a(()=>[e(l.$slots,"aside-custom")]),default:a(()=>[e(l.$slots,"default")]),_:3},8,["frontmatter"])}}};export{Y as default,M as usePageData};
