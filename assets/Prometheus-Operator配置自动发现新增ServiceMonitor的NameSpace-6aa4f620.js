import{_ as i}from"./ValaxyMain.vue_vue_type_style_index_0_lang-ea3fcc0b.js";import{_ as C,c as A,w as e,o as m,b as s,U as n,q as c,r as l,W as y,p as D}from"./app-2079813c.js";import"./YunFooter.vue_vue_type_script_setup_true_lang-d6f60392.js";import"./YunCard.vue_vue_type_style_index_0_lang-9f0e67a9.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang-6e5bced3.js";const z=JSON.parse('{"title":"Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace","description":"","frontmatter":{"title":"Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace","categories":"Prometheus","tags":["kube-prometheus","Prometheus-Operator","Service-Monitor"],"date":"2021-11-24T16:23:00.000Z"},"headers":[{"level":2,"title":"1. 监控其他 namespace 中的 endpoint 资源","slug":"_1-监控其他-namespace-中的-endpoint-资源","link":"#_1-监控其他-namespace-中的-endpoint-资源","children":[]},{"level":2,"title":"2. 监控其他 namespace 中的 serviceMonitor 资源","slug":"_2-监控其他-namespace-中的-servicemonitor-资源","link":"#_2-监控其他-namespace-中的-servicemonitor-资源","children":[]}],"relativePath":"pages/posts/Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace.md","path":"/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace.md","lastUpdated":1671090556000}'),o=JSON.parse('{"title":"Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace","description":"","frontmatter":{"title":"Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace","categories":"Prometheus","tags":["kube-prometheus","Prometheus-Operator","Service-Monitor"],"date":"2021-11-24T16:23:00.000Z"},"headers":[{"level":2,"title":"1. 监控其他 namespace 中的 endpoint 资源","slug":"_1-监控其他-namespace-中的-endpoint-资源","link":"#_1-监控其他-namespace-中的-endpoint-资源","children":[]},{"level":2,"title":"2. 监控其他 namespace 中的 serviceMonitor 资源","slug":"_2-监控其他-namespace-中的-servicemonitor-资源","link":"#_2-监控其他-namespace-中的-servicemonitor-资源","children":[]}],"relativePath":"pages/posts/Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace.md","path":"/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace.md","lastUpdated":1671090556000}'),d={name:"pages/posts/Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace.md",data(){return{data:o,frontmatter:o.frontmatter}},setup(){D("pageData",o)}},u=s("blockquote",null,[s("p",null,[n("最近在监控k8s当中的Jenkins 的时候,新增ServiceMonitor总是不显示,这里的不显示指的是不在Prometheus-Operator中显示,我认为这其中一定有问题,于是查阅了大量的资料,终于从中找到了答案, 原因竟是Prometheus-Operator在安装的时候默认只会自动发现"),s("code",null,"default"),n(","),s("code",null,"kube-system"),n(","),s("code",null,"monitoring"),n("这三个名称空间下新建的ServiceMonitor,而我的ServiceMonitor又是新建在别的名称空间下所以他无法进行自动发现")]),s("p",null,"更奇怪的是,网上对这个问题的记录文章几乎为0,我根本找不到,所以才写下这个笔记,供看到的人借鉴!")],-1),h={id:"_1-监控其他-namespace-中的-endpoint-资源",tabindex:"-1"},v=s("p",null,"需要做的操作",-1),g=s("ol",null,[s("li",null,"创建新增命名空间的 role， 用于获取监控的信息。"),s("li",null,"将创建的role绑定到 monitoring 命名空间中的 prometheus-k8s SA。")],-1),_=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"kubectl create ns test")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      serviceMonitor: prometheus")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"COPY")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),M=s("p",null,"添加命名空间的标签",-1),P=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"for ns in default kube-system monitoring test; do ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"COPY")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),O=s("p",null,"添加 serviceMonitor 的标签",-1),$=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},`kubectl patch -n test servicemonitor demo-app --patch '{"metadata":{"labels":{"serviceMonitor":"prometheus"}}}' --type=merge`)]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"COPY")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),N=s("p",null,"测试",-1),V=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"cat <<EOF | kubectl-test apply -f - ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      app: ingress-demo-app")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"EOF")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),w=s("p",null,"希望能对你有所帮助",-1);function x(a,L,U,B,p,E){const t=y,r=i;return m(),A(r,{frontmatter:p.frontmatter,data:p.data},{"main-content-md":e(()=>[u,s("h2",h,[n("1. 监控其他 namespace 中的 endpoint 资源 "),c(t,{class:"header-anchor",href:"#_1-监控其他-namespace-中的-endpoint-资源","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),v,g,_,s("h2",k,[n("2. 监控其他 namespace 中的 serviceMonitor 资源 "),c(t,{class:"header-anchor",href:"#_2-监控其他-namespace-中的-servicemonitor-资源","aria-hidden":"true"},{default:e(()=>[n("#")]),_:1})]),b,f,S,M,P,O,$,N,V,w]),"main-header":e(()=>[l(a.$slots,"main-header")]),"main-header-after":e(()=>[l(a.$slots,"main-header-after")]),"main-nav":e(()=>[l(a.$slots,"main-nav")]),"main-content":e(()=>[l(a.$slots,"main-content")]),"main-content-after":e(()=>[l(a.$slots,"main-content-after")]),"main-nav-before":e(()=>[l(a.$slots,"main-nav-before")]),"main-nav-after":e(()=>[l(a.$slots,"main-nav-after")]),comment:e(()=>[l(a.$slots,"comment")]),footer:e(()=>[l(a.$slots,"footer")]),aside:e(()=>[l(a.$slots,"aside")]),"aside-custom":e(()=>[l(a.$slots,"aside-custom")]),default:e(()=>[l(a.$slots,"default")]),_:3},8,["frontmatter","data"])}const G=C(d,[["render",x]]);export{z as __pageData,G as default};
