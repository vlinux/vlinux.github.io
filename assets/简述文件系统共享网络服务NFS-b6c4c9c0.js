...
`)],-1),qn=n("p",null,"客户端操作:",-1),$n=n("pre",null,[n("code",null,`[root@backup ~]# mount -t nfs 172.16.1.31:/data /data
...
oldzhangy
`)],-1),Un=n("p",null,"我们会发现依然可以写入，但是为了避免这种情况发生，建议客户端也创建相同uid gid的用户",-1),Bn=n("pre",null,[n("code",null,`[root@backup ~]# groupadd -g 666 www
