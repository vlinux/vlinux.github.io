import{_ as p}from"./ValaxyMain.vue_vue_type_style_index_0_lang-9abaf40c.js";import{_ as A,c as C,w as n,o as d,b as s,U as e,q as t,r as l,W as D,p as y}from"./app-72d5294e.js";import"./YunFooter.vue_vue_type_script_setup_true_lang-aa07348b.js";import"./YunCard.vue_vue_type_style_index_0_lang-b9c57d9f.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang-538d271c.js";const M=JSON.parse('{"title":"Docker基本四种网络模型","description":"","frontmatter":{"title":"Docker基本四种网络模型","categories":"DevOps","tags":["Docker"],"date":"2020-06-23T16:40:00.000Z"},"headers":[{"level":3,"title":"一，NAT（最小）","slug":"一，nat（最小）","link":"#一，nat（最小）","children":[]},{"level":3,"title":"二，none","slug":"二，none","link":"#二，none","children":[]},{"level":3,"title":"三，主机（与主机相同IP）","slug":"三，主机（与主机相同ip）","link":"#三，主机（与主机相同ip）","children":[]},{"level":3,"title":"四，联合网络（即两个容器共享一个IP地址）","slug":"四，联合网络（即两个容器共享一个ip地址）","link":"#四，联合网络（即两个容器共享一个ip地址）","children":[]}],"relativePath":"pages/posts/Docker基本四种网络模型.md","path":"/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/Docker基本四种网络模型.md","lastUpdated":1671090556000}'),r=JSON.parse('{"title":"Docker基本四种网络模型","description":"","frontmatter":{"title":"Docker基本四种网络模型","categories":"DevOps","tags":["Docker"],"date":"2020-06-23T16:40:00.000Z"},"headers":[{"level":3,"title":"一，NAT（最小）","slug":"一，nat（最小）","link":"#一，nat（最小）","children":[]},{"level":3,"title":"二，none","slug":"二，none","link":"#二，none","children":[]},{"level":3,"title":"三，主机（与主机相同IP）","slug":"三，主机（与主机相同ip）","link":"#三，主机（与主机相同ip）","children":[]},{"level":3,"title":"四，联合网络（即两个容器共享一个IP地址）","slug":"四，联合网络（即两个容器共享一个ip地址）","link":"#四，联合网络（即两个容器共享一个ip地址）","children":[]}],"relativePath":"pages/posts/Docker基本四种网络模型.md","path":"/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/Docker基本四种网络模型.md","lastUpdated":1671090556000}'),u={name:"pages/posts/Docker基本四种网络模型.md",data(){return{data:r,frontmatter:r.frontmatter}},setup(){y("pageData",r)}},m={id:"一，nat（最小）",tabindex:"-1"},h=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"NAT网络模型，默认情况下，均为NAT模式，如网络的端口映射就为NAT")]),e(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),f={id:"二，none",tabindex:"-1"},k=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"格式：docker run --net=none")]),e(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),g={id:"三，主机（与主机相同ip）",tabindex:"-1"},v=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"格式：docker run --net=host")]),e(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})]),e(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0")]),e(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),_={id:"四，联合网络（即两个容器共享一个ip地址）",tabindex:"-1"},b=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"第一个容器运行")]),e(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-----")]),e(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        TX packets 0  bytes 0 (0.0 B)")]),e(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0")]),e(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1);function T(a,N,R,X,c,U){const o=D,i=p;return d(),C(i,{frontmatter:c.frontmatter,data:c.data},{"main-content-md":n(()=>[s("h3",m,[e("一，NAT（最小） "),t(o,{class:"header-anchor",href:"#一，nat（最小）","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),h,s("h3",f,[e("二，none "),t(o,{class:"header-anchor",href:"#二，none","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),k,s("h3",g,[e("三，主机（与主机相同IP） "),t(o,{class:"header-anchor",href:"#三，主机（与主机相同ip）","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),v,s("h3",_,[e("四，联合网络（即两个容器共享一个IP地址） "),t(o,{class:"header-anchor",href:"#四，联合网络（即两个容器共享一个ip地址）","aria-hidden":"true"},{default:n(()=>[e("#")]),_:1})]),b]),"main-header":n(()=>[l(a.$slots,"main-header")]),"main-header-after":n(()=>[l(a.$slots,"main-header-after")]),"main-nav":n(()=>[l(a.$slots,"main-nav")]),"main-content":n(()=>[l(a.$slots,"main-content")]),"main-content-after":n(()=>[l(a.$slots,"main-content-after")]),"main-nav-before":n(()=>[l(a.$slots,"main-nav-before")]),"main-nav-after":n(()=>[l(a.$slots,"main-nav-after")]),comment:n(()=>[l(a.$slots,"comment")]),footer:n(()=>[l(a.$slots,"footer")]),aside:n(()=>[l(a.$slots,"aside")]),"aside-custom":n(()=>[l(a.$slots,"aside-custom")]),default:n(()=>[l(a.$slots,"default")]),_:3},8,["frontmatter","data"])}const O=A(u,[["render",T]]);export{M as __pageData,O as default};
