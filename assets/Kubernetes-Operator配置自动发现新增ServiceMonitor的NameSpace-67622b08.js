...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      app: ingress-demo-app")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"EOF")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),N=s("p",null,"希望",-1);function $(a,x,K,V,p,w){const t=c;return A(),C(t,{frontmatter:p.frontmatter,data:p.data},{"main-content-md":e(()=>[y,D,d,u,h,v,g,_,b,k,f,S,M,O,P,N]),"main-header":e(()=>[l(a.$slots,"main-header")]),"main-header-after":e(()=>[l(a.$slots,"main-header-after")]),"main-nav":e(()=>[l(a.$slots,"main-nav")]),"main-content":e(()=>[l(a.$slots,"main-content")]),"main-content-after":e(()=>[l(a.$slots,"main-content-after")]),"main-nav-before":e(()=>[l(a.$slots,"main-nav-before")]),"main-nav-after":e(()=>[l(a.$slots,"main-nav-after")]),comment:e(()=>[l(a.$slots,"comment")]),footer:e(()=>[l(a.$slots,"footer")]),aside:e(()=>[l(a.$slots,"aside")]),"aside-custom":e(()=>[l(a.$slots,"aside-custom")]),default:e(()=>[l(a.$slots,"default")]),_:3},8,["frontmatter","data"])}const T=r(m,[["render",$],["__file","/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/Kubernetes-Operator配置自动发现新增ServiceMonitor的NameSpace.md"]]);export{L as __pageData,T as default};
