...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      serviceMonitor: prometheus")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"COPY")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),k=s("p",null,"添加命名空间的标签",-1),S=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",null,[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"for ns in default kube-system monitoring test; do ")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"COPY")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),f=s("p",null,"添加 serviceMonitor 的标签",-1),M=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",null,[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},`kubectl patch -n test servicemonitor demo-app --patch '{"metadata":{"labels":{"serviceMonitor":"prometheus"}}}' --type=merge`)]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"COPY")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"      app: ingress-demo-app")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"EOF")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),N=s("p",null,"希望能对你有所帮助",-1);function $(a,x,V,w,p,R){const t=c;return A(),C(t,{frontmatter:p.frontmatter,data:p.data},{"main-content-md":e(()=>[y,D,d,u,h,v,g,_,b,k,S,f,M,P,O,N]),"main-header":e(()=>[l(a.$slots,"main-header")]),"main-header-after":e(()=>[l(a.$slots,"main-header-after")]),"main-nav":e(()=>[l(a.$slots,"main-nav")]),"main-content":e(()=>[l(a.$slots,"main-content")]),"main-content-after":e(()=>[l(a.$slots,"main-content-after")]),"main-nav-before":e(()=>[l(a.$slots,"main-nav-before")]),"main-nav-after":e(()=>[l(a.$slots,"main-nav-after")]),comment:e(()=>[l(a.$slots,"comment")]),footer:e(()=>[l(a.$slots,"footer")]),aside:e(()=>[l(a.$slots,"aside")]),"aside-custom":e(()=>[l(a.$slots,"aside-custom")]),default:e(()=>[l(a.$slots,"default")]),_:3},8,["frontmatter","data"])}const Y=r(m,[["render",$],["__file","/Users/vlinux/vlinux/blog/valaxy/vlinux.github.io/pages/posts/Prometheus-Operator配置自动发现新增ServiceMonitor的NameSpace.md"]]);export{T as __pageData,Y as default};
