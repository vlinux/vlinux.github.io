...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),G=s("p",null,[s("strong",null,"查看集群成员"),l(" 新开一个终端窗口运行"),s("code",null,"consul members"),l(", 你可以看到Consul集群的成员.")],-1),M=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# consul members")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),W={id:"启动-consul-client",tabindex:"-1"},K=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"consul agent -data-dir /tmp/consul -node=c1 -bind=10.201.102.248 -config-dir=/etc/consul.d/ -join 10.201.102.198")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),q=s("p",null,[l("运行cosnul agent以client模式，"),s("code",null,"-join"),l(" 加入到已有的集群中去。")],-1),$=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-248 ~]# consul agent -data-dir /tmp/consul -node=c1 -bind=10.201.102.248 -config-dir=/etc/consul.d/ -join 10.201.102.198")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"==> Starting Consul agent...")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"==> Starting Consul agent RPC...")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),vs=s("p",null,[l("如你所见,一个"),s("code",null,"A"),l("记录返回了一个可用的服务所在的节点的IP地址."),s("code",null,"A"),l("记录只能设置为IP地址. 有也可用使用 DNS API 来接收包含 地址和端口的 SRV记录:")],-1),ms=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# dig @127.0.0.1 -p 8600 web.service.consul SRV")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]#")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),fs=s("p",null,[s("code",null,"SRV"),l("记录告诉我们 web 这个服务运行于节点"),s("code",null,"dhcp-10-201-102-198"),l(" 的"),s("code",null,"80"),l("端口. DNS额外返回了节点的A记录.")],-1),ks=s("p",null,[l("最后,我们也可以用 DNS API 通过标签来过滤服务.基于标签的服务查询格式为"),s("code",null,"TAG.NAME.service.consul"),l(". 在下面的例子中,我们请求Consul返回有 "),s("code",null,"rails"),l("标签的 "),s("code",null,"web"),l("服务.我们成功获取了我们注册为这个标签的服务:")],-1),bs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# dig @127.0.0.1 -p 8600 rails.web.service.consul SRV")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]#")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ws=s("p",null,[s("strong",null,"HTTP API"),l(" 除了DNS API之外,HTTP API也可以用来进行服务查询:")],-1),Ts=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# curl -s 127.0.0.1:8500/v1/catalog/service/web | python -m json.tool")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    {")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"]")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),xs=s("p",null,"目录API给出所有节点提供的服务.稍后我们会像通常的那样带上健康检查进行查询.就像DNS内部处理的那样.这是只查看健康的实例的查询方法:",-1),Is=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# curl -s 127.0.0.1:8500/v1/catalog/service/web?passing | python -m json.tool")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    {")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'        "Address": "10.201.102.198",')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'        "CreateIndex": 492843,')]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ws=s("p",null,"or",-1),Ks=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/etc/consul.d/web.json1")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{"service": {')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'    "name": "Faceid",')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'    "tags": ["extract", "verify", "compare", "idcard"],')]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"]")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),zs=s("p",null,[l("我们可以看到,只有一个检查我们的"),s("code",null,"web"),l("服务在"),s("code",null,"critical"),l("状态")],-1),Xs=s("p",null,"另外,我们可以尝试用DNS查询web服务,Consul将不会返回结果.因为服务不健康.",-1),Bs=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# dig @127.0.0.1 -p 8600 Faceid.service.consul SRV")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ys={id:"k-／v",tabindex:"-1"},Zs=s("p",null,"除了提供服务发现和健康检查的集成.Consul提供了一个易用的键/值存储.这可以用来保持动态配置,协助服务协调,领袖选举,做开发者可以想到的任何事情.",-1),sl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# curl -v http://localhost:8500/v1/kv/?recurse")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ll=s("p",null,[l("因为没有key所以我们得到了一个404响应.现在我们"),s("code",null,"PUT"),l("一些示例的Key:")],-1),nl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# curl -X PUT -d 'test' http://localhost:8500/v1/kv/web/key1")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    }")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"]")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),il=s("p",null,[l("删除key也很简单.通过"),s("code",null,"DELETE"),l("动作来完成.我们可以通过指定完整路径来删除一个单独的key.或者我们可以使用"),s("code",null,"?recurse"),s("strong",null,"递归"),l("的删除主路径下所有key.")],-1),rl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"[root@dhcp-10-201-102-198 ~]# curl -X DELETE http://localhost:8500/v1/kv/web/sub?recurse")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),_l={id:"agent",tabindex:"-1"},vl=s("p",null,[s("code",null,"agent"),l("指令是consul的核心，它运行agent来维护成员的重要信息、运行检查、服务宣布、查询处理等等。")],-1),ml=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"==> Usage: consul agent [options]")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),fl={id:"event",tabindex:"-1"},kl=s("p",null,[s("code",null,"event"),l("命令提供了一种机制，用来fire自定义的用户事件，这些事件对consul来说是不透明的，但它们可以用来构建自动部署、重启服务或者其他行动的脚本。")],-1),bl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-http-addr：http服务的地址，agent可以链接上来发送命令，如果没有设置，则默认是127.0.0.1:8500。")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),wl={id:"exec",tabindex:"-1"},Tl=s("p",null,[s("code",null,"exec"),l("指令提供了一种远程执行机制，比如你要在所有的机器上执行uptime命令，远程执行的工作通过job来指定，存储在KV中，agent使用event系统可以快速的知道有新的job产生，消息是通过gossip协议来传递的，因此消息传递是最佳的，但是并不保证命令的执行。事件通过gossip来驱动，远程执行依赖KV存储系统(就像消息代理一样)。")],-1),xl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-http-addr：http服务的地址，agent可以链接上来发送命令，如果没有设置，则默认是127.0.0.1:8500。")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-datacenter：数据中心。")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),$l={id:"monitor",tabindex:"-1"},Ql=s("p",null,[s("code",null,"monitor"),l("指令用来链接运行的agent，并显示日志。monitor会显示最近的日志，并持续的显示日志流，不会自动退出，除非你手动或者远程agent自己退出。")],-1),Jl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-log-level：显示哪个级别的日志，默认是info")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-rpc-addr：一个rpc地址，agent可以链接上来发送命令，如果没有指定，默认是127.0.0.1:8400")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),zl={id:"reload",tabindex:"-1"},Xl=s("p",null,[s("code",null,"reload"),l("指令可以重新加载agent的配置文件。SIGHUP指令在重新加载配置文件时使用，任何重新加载的错误都会写在agent的log文件中，并不会打印到屏幕。")],-1),Bl=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-rpc-addr：一个rpc地址，agent可以链接上来发送命令，如果没有指定，默认是127.0.0.1:8400")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Yl={id:"version",tabindex:"-1"},Zl=s("p",null,"打印consul的版本",-1),sn={id:"watch",tabindex:"-1"},ln=s("p",null,[s("code",null,"watch"),l("指令提供了一个机制，用来监视实际数据视图的改变(节点列表、成员服务、KV)，如果没有指定进程，当前值会被dump出来")],-1),nn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-http-addr：http服务的地址，agent可以链接上来发送命令，如果没有设置，则默认是127.0.0.1:8500。")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),en={id:"consul-配置",tabindex:"-1"},an=s("p",null,"agent有各种各样的配置项可以在命令行或者配置文件进行定义，所有的配置项都是可选择的，当加载配置文件的时候，consul从配置文件或者配置目录加载配置。后面定义的配置会合并前面定义的配置，但是大多数情况下，合并的意思是后面定义的配置会覆盖前面定义的配置，但是有些情况，例如event句柄，合并仅仅是添加到前面定义的句柄后面。consul重新加载配置文件也支持以信号的方式接收update信号。",-1),on=s("p",null,"下面看看命令行参数：",-1),tn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-advertise：通知展现地址用来改变我们给集群中的其他节点展现的地址，一般情况下-bind地址就是展现地址")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),cn=s("p",null,"除了命令行参数外，配置也可以写入文件中，在某些情况下配置文件会更简单一些，例如：利用consul被用来管理系统。配置文件是json格式的，很容易编写。配置文件不仅被用来设置agent的启动，也可以用来提供健康检测和服务发现的定义。配置文件的一般样例如下：",-1),rn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'  "datacenter": "dc1",')]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),pn=s("p",null,"下面看看详细的配置文件参数：",-1),Cn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"acl_datacenter：只用于server，指定的datacenter的权威ACL信息，所有的servers和datacenter必须同意ACL datacenter")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),An={id:"http-api",tabindex:"-1"},dn=s("p",null,"consul的主要接口是RESTful HTTP API，该API可以用来增删查改nodes、services、checks、configguration。所有的endpoints主要分为以下类别：",-1),un=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"kv - Key/Value存储")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),yn=s("p",null,"下面我们就单独看看每个模块的具体内容。",-1),hn={id:"agent-1",tabindex:"-1"},Dn=s("p",null,"agent endpoints用来和本地agent进行交互，一般用来服务注册和检查注册，支持以下接口",-1),gn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/agent/checks : 返回本地agent注册的所有检查(包括配置文件和HTTP接口)")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),_n={id:"catalog",tabindex:"-1"},vn=s("p",null,"catalog endpoints用来注册/注销nodes、services、checks",-1),mn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/catalog/register : Registers a new node, service, or check")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),fn={id:"health",tabindex:"-1"},kn=s("p",null,"health endpoints用来查询健康状况相关信息，该功能从catalog中单独分离出来",-1),bn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/healt/node/<node>: 返回node所定义的检查，可用参数?dc=")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),wn={id:"session",tabindex:"-1"},Tn=s("p",null,"session endpoints用来create、update、destory、query sessions",-1),xn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/session/create: Creates a new session")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),In={id:"acl",tabindex:"-1"},Sn=s("p",null,"acl endpoints用来create、update、destory、query acl",-1),Nn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/acl/create: Creates a new token with policy")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Pn={id:"event-1",tabindex:"-1"},En=s("p",null,"event endpoints用来fire新的events、查询已有的events",-1),Rn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/event/fire/<name>: 触发一个新的event，用户event需要name和其他可选的参数，使用PUT方法")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/event/list: 返回agent知道的events")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),jn={id:"status",tabindex:"-1"},Ln=s("p",null,"status endpoints用来或者consul 集群的信息",-1),On=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/status/leader : 返回当前集群的Raft leader")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"/v1/status/peers : 返回当前集群中同事")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Vn={id:"consul-template",tabindex:"-1"},Hn=s("p",null,"在consul-template没出现之前，大家构建服务发现系统，大多采用的是zookeeper、etcd+confd这样类似的系统，之前写过一篇consul+confd的文，讲的是如何动态生成配置文件的，如今consul官方推出了自己的模板系统，就是consul-template，这样的话动态的配置系统可以分化为etcd+confd和consul+consul-template两大阵营。consul是一个和etcd类似但又强于etcd的系统，关于etcd和consul可以翻阅以前的文章，consul-template的定位就和confd差不多一样了，confd的后端可以是etcd或者consul，相信consul搭配consul-template能发挥更大的效果。consul-template提供了一个便捷的方式从consul中获取存储的值，consul-template守护进程会查询consul实例，来更新系统上指定的任何模板，当更新完成后，模板可以选择运行一些任意的命令。",-1),Fn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    consul template的使用场景：consul template可以查询consul中的服务目录、key、key-values等。这种强大的抽象功能和查询语言模板可以使consul template特别适合动态的创建配置文件。例如：创建apache/nginx proxy balancers、haproxy backends、varnish servers、application configurations。")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Un=s("p",null,"consul template的特性：",-1),Gn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    quiescence：consul template内制静止平衡功能，可以智能的发现consul实例中的更改信息。这个功能可以防止频繁的更新模板而引起系统的波动。")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Mn={id:"安装",tabindex:"-1"},Wn={id:"使用",tabindex:"-1"},Kn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"-auth=<user[:pass]>      设置基本的认证用户名和密码")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),qn=s("p",null,"查看全部选项,使用以下命令",-1),$n=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"consul-template -h")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Qn={id:"命令行",tabindex:"-1"},Jn=s("p",null,"1、查询本地consl实例，生成模板后重启nginx，如果consul不可用，如果api故障则每30s尝试检测一次值，consul-template运行一次后退出",-1),zn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'consul-template -retry 30s -once -consul-addr=10.201.102.198:8500 -template "test.ctmpl:test.out"')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Xn=s("p",null,"test.ctmpl",-1),Bn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{range service "Faceid"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{.ID}} {{.Address}}:{{.Port}} check inter 5000 fall 1 rise 2 weight 2{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Yn=s("p",null,"test.out",-1),Zn=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"Faceid 10.201.102.198:9000 check inter 5000 fall 1 rise 2 weight 2")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),se=s("p",null,"2、运行consul-temple作为一个服务",-1),le=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'consul-template -consul-addr=10.201.102.198:8500 -template "test.ctmpl:test.out"')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ne=s("p",null,"3、查询一个实例，渲染多个模板，然后重启相关服务",-1),ee=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'consul-template -retry 30s -once -consul-addr=10.201.102.198:8500 -template "test.ctmpl:test.out"\\')]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ae=s("p",null,"4、查询一个实例，dump模板到标准输出，参数中的-template则会被忽略",-1),oe=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'consul-template -dry -consul-addr=10.201.102.198:8500 -template "test.ctmpl:test.out"')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),te=s("p",null,"以上参数除了在命令行使用，也可以直接配置在文件中，下面看看Consul-Template的配置文件，简称HCL(HashiCorp Configuration Language)，它是和JSON兼容的，下面看个例子：",-1),ce=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"#### 配置文件")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ie=s("p",null,[s("strong",null,"注意"),l(": 不是所有的选项都是必选的.例如: 如果你没有使用Vault你不用设置这一块. 类似的你没有使用syslog系统你也不需要指定syslog配置.")],-1),re=s("p",null,[l("为了更加安全,"),s("code",null,"token"),l("也可以从环境变量里读取,使用 "),s("code",null,"CONSUL_TOKEN"),l(" 和 "),s("code",null,"VAULT_TOKEN"),l(".强烈建议你不要把token放到未加密的文本配置文件中.")],-1),pe={id:"模版语法",tabindex:"-1"},Ce=s("p",null,"Consul Template 使用了Go的模板语法.如果你对他的语法不熟悉建议你读下文档.他的语法看起来与 Mustache, Handlebars, 或者 Liquid 类似.",-1),Ae=s("p",null,"在Go 提供的模板函数之外,Consul Template暴露了以下的函数:",-1),de={id:"api-函数",tabindex:"-1"},ue=s("p",null,[s("strong",null,"datacenters"),l(" 查询目录中的所有数据中心.使用以下语法:")],-1),ye=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{datacenters}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),he=s("p",null,[s("strong",null,"file"),l(" 读取并输出磁盘上的本地文件,如果无法读取产生一个错误.使用如下语法")],-1),De=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{file "/path/to/local/file"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ge=s("p",null,[l("这个例子将输出 "),s("code",null,"/path/to/local/file"),l(" 文件内容到模板. 注意:这不会在嵌套模板中被处理")],-1),_e=s("p",null,[s("strong",null,"key"),l(" 查询Consul指定key的值,如果key的值不能转换为字符串,将产生错误.使用如下语法:")],-1),ve=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{key "service/redis/maxconns@east-aws"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),me=s("p",null,[l("上面的例子查询了在"),s("code",null,"east-aws"),l("数据中心的 "),s("code",null,"service/redis/maxconns"),l("的值.如果忽略数据中心参数,将会查询本地数据中心的值:")],-1),fe=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{key "service/redis/maxconns"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ke=s("p",null,"Consul键值结构的美妙在于,这完全取决于你!",-1),be=s("p",null,[s("strong",null,"key_or_default"),l(" 查询Consul中指定的key的值,如果key不存在,则返回默认值.使用方式如下")],-1),we=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{key_or_default "service/redis/maxconns@east-aws" "5"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Te=s("p",null,[l("注意Consul Template使用了多个阶段的运算.在第一阶段的运算如果Consul没有返回值,则会一直使用默认值.后续模板解析中如果值存在了则会读取真实的值.这很重要,运维Consul Templae不会因为"),s("code",null,"key_or_default"),l("没找到key而阻塞模板的的渲染.即使key存在如果Consul没有按时返回这个数据,也会使用默认值来进行替代.")],-1),xe=s("p",null,[s("strong",null,"ls"),l(" 查看Consul的所有以指定前缀开头的key-value对.如果有值无法转换成字符串则会产生一个错误:")],-1),Ie=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{range ls "service/redis@east-aws"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{.Key}} {{.Value}}{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Se=s("p",null,[l("如果Consul实例在"),s("code",null,"east-aws"),l("数据中心存在这个结构"),s("code",null,"service/redis"),l(",渲染后的模板应该类似这样:")],-1),Ne=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"minconns 2")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"maxconns 12")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Pe=s("p",null,"如果你忽略数据中心属性,则会返回本地数据中心的查询结果.",-1),Ee=s("p",null,[s("strong",null,"node"),l(" 查询目录中的一个节点信息")],-1),Re=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{node "node1"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),je=s("p",null,"如果未指定任何参数,则当前agent所在节点将会被返回:",-1),Le=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{node}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Oe=s("p",null,"你可以指定一个可选的参数来指定数据中心:",-1),Ve=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{node "node1" "@east-aws"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),He=s("p",null,[l("如果指定的节点没有找到则会返回"),s("code",null,"nil"),l(".如果节点存在就会列出节点的信息和节点提供的服务.")],-1),Fe=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{with node}}{{.Node.Node}} ({{.Node.Address}}){{range .Services}}")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ue=s("p",null,[s("strong",null,"nodes"),l(" 查询目录中的全部节点,使用如下语法")],-1),Ge=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{nodes}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Me=s("p",null,"这个例子会查询Consul的默认数据中心.你可以使用可选参数指定一个可选参数来指定数据中心:",-1),We=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{nodes "@east-aws"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ke=s("p",null,"这个例子会查询east-aws数据中心的所有几点.",-1),qe=s("p",null,[s("strong",null,"secret"),l(" 查询"),s("code",null,"Vault"),l("中指定路径的密匙.如果指定的路径不存在或者"),s("code",null,"Vault"),l("的"),s("code",null,"Token"),l("没有足够权限去读取指定的路径,将会产生一个错误.如果路径存在但是key不存在则返回“.")],-1),$e=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{with secret "secret/passwords"}}{{.Data.password}}{{end}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Qe=s("p",null,"可以使用如下字段:",-1),Je=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"LeaseID - the unique lease identifier")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),la=s("p",null,"You should probably never do this. Please also note that Vault does not support blocking queries. To understand the implications, please read the note at the end of the secret function.",-1),na=s("p",null,[s("strong",null,"service"),l(" 查询Consul中匹配表达式的服务.语法如下:")],-1),ea=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{service "release.web@east-aws"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),aa=s("p",null,[l("上面的例子查询Consul中,在"),s("code",null,"east-aws"),l("数据中心存在的健康的 "),s("code",null,"web"),l("服务.tag和数据中心参数是可选的.从当前数据中心查询所有节点的"),s("code",null,"web"),l("服务而不管tag,查询语法如下:")],-1),oa=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{service "web"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ta=s("p",null,[l("这个函数返回"),s("code",null,"[]*HealthService"),l("结构.可按照如下方式应用到模板:")],-1),ca=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{range service "web@data center"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"server {{.Name}} {{.Address}}:{{.Port}}{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ia=s("p",null,"产生如下输出:",-1),ra=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"server nyc_web_01 123.456.789.10:8080")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"server nyc_web_02 456.789.101.213:8080")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),pa=s("p",null,[l("默认值会返回健康的服务,如果你想获取所有服务,可以增加"),s("code",null,"any"),l("选项,如下:")],-1),Ca=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{service "web" "any"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Aa=s("p",null,"这样就会返回注册过的所有服务,而不论他的状态如何.",-1),da=s("p",null,"如果你想过滤指定的一个或者多个健康状态,你可以通过逗号隔开多个健康状态:",-1),ua=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{service "web" "passing, warning"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ya=s("p",null,[l("这样将会返回被他们的节点和服务级别的检查定义标记为 “passing” 或者 “warning”的服务. 请注意逗号是 "),s("code",null,"OR"),l("而不是"),s("code",null,"AND"),l("的意思.")],-1),ha=s("p",null,[l("指定了超过一个状态过滤,并包含"),s("code",null,"any"),l("将会返回一个错误.因为"),s("code",null,"any"),l("是比所有状态更高级的过滤.")],-1),Da=s("p",null,"后面这2种方式有些架构上的不同:",-1),ga=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{service "web"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{service "web" "passing"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),_a=s("p",null,[l("前者会返回Consul认为"),s("code",null,"healthy"),l("和"),s("code",null,"passing"),l("的所有服务.后者将返回所有已经在Consul注册的服务.然后会执行一个客户端的过滤.通常如果你想获取健康的服务,你应该不要使用"),s("code",null,"passing"),l("参数,直接忽略第三个参数即可.然而第三个参数在你想查询 passing或者"),s("code",null,"warning"),l("的服务会比较有用,如下:")],-1),va=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{service "web" "passing, warning"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ma=s("p",null,"服务的状态也是可见的,如果你想自己做一些额外的过滤,语法如下:",-1),fa=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{range service "web" "any"}}')]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),ka=s("p",null,[l("执行命令时,在Consul将服务设置为维护模式,只需要在你的命令上包上Consul的 "),s("code",null,"maint"),l(" 调用:")],-1),ba=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"#!/bin/sh")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),wa=s("p",null,"另外如果你没有安装Consul agent,你可以直接调用API请求:",-1),Ta=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"#!/bin/sh")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"set -e")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),xa=s("p",null,[s("strong",null,"services"),l(" 查询Consul目录中的所有服务,使用如下语法:")],-1),Ia=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{services}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Sa=s("p",null,"这个例子将查询Consul的默认数据中心,你可以指定一个可选参数来指定数据中心:",-1),Na=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{services "@east-aws"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Pa=s("p",null,"请注意: services函数与service是不同的,service接受更多参数并且查询监控的服务列表.这个查询Consul目录并返回一个服务的tag的Map,如下:",-1),Ea=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{range services}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{.Name}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{range .Tags}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  {{.}}{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ra=s("p",null,[s("strong",null,"tree"),l(" 查询所有指定前缀的key-value值对,如果其中的值有无法转换为字符串的则引发错误:")],-1),ja=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'{{range tree "service/redis@east-aws"}}')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"{{.Key}} {{.Value}}{{end}}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),La=s("p",null,[l("如果Consul实例在"),s("code",null,"east-aws"),l("数据中心有一个"),s("code",null,"service/redis"),l("结构,模板的渲染结果类似下面:")],-1),Oa=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"minconns 2")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"maxconns 12")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'nested/config/value "value"')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Va=s("p",null,[l("和"),s("code",null,"ls"),l("不同,"),s("code",null,"tree"),l("返回前缀下的所有key.和Unix的tree命令比较像.如果忽略数据中心参数,则会使用本地数据中心")],-1),Ha={id:"haproxy-实例",tabindex:"-1"},Fa=s("p",null,[l("根据haproxy服务的配置文件创建一个consul-template模版渲染文件："),s("code",null,"haproxy.ctmpl")],-1),Ua=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"# Consul Haproxy configured")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Ga=s("p",null,"运行consul-template作为一个服务,通过上面的渲染模版渲染一个haproxy.cfg的配置文件，然后重启haproxy服务",-1),Ma=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},'consul-template -consul-addr=10.201.102.185:8500 -template "/root/haproxy.ctmpl:/etc/haproxy.cfg:service haproxy restart"')]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),Wa=s("p",null,[l("渲染后的"),s("code",null,"haproxy.cfg")],-1),Ka=s("div",{class:"language-"},[s("span",{class:"copy"}),s("pre",{class:"shiki material-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"# Consul Haproxy configured")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"global")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        maxconn         20480")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        ulimit-n        65535")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"        log             127.0.0.1 local5")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}})])])])],-1),qa=s("p",null,"整个就是搭建consul集群，平台中的服务会注册到consul集群中，haproxy避免consul-template调consul时出现单点故障consul-template无法工作做的高可用，Consul-template就是能在整个平台的各个系统和应用中使用，查询consul集群来获取平台上各个应用的存活状态和IP。",-1),$a=s("p",null,"整套下来实现了两个重点：",-1),Qa=s("p",null,"实现了中心服务注册查询 平台中其他节点的查询服务和配置文件自动更新",-1),Ja={id:"参考资料",tabindex:"-1"},za={id:"下载",tabindex:"-1"};function Xa(o,Ba,Ya,Za,i,so){const e=u,r=p;return d(),A(r,{frontmatter:i.frontmatter,data:i.data},{"main-content-md":n(()=>[s("h1",D,[l("使用consul "),a(e,{class:"header-anchor",href:"#使用consul","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),s("h2",g,[l("介绍 "),a(e,{class:"header-anchor",href:"#介绍","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),_,v,s("h2",m,[l("基础架构 "),a(e,{class:"header-anchor",href:"#基础架构","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),f,k,b,w,T,s("p",null,[l("更多介绍查看官网"),a(e,{href:"https://www.consul.io/",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("点击前往")]),_:1})]),s("h2",x,[l("安装Consul "),a(e,{class:"header-anchor",href:"#安装consul","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),s("p",null,[l("安装Consul,找到适合你系统的包下载他.Consul打包为一个’Zip’文件."),a(e,{href:"https://www.consul.io/downloads.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("前往下载")]),_:1})]),I,s("h2",S,[l("验证安装 "),a(e,{class:"header-anchor",href:"#验证安装","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),N,P,E,s("h2",R,[l("运行Agent "),a(e,{class:"header-anchor",href:"#运行agent","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),j,L,s("p",null,[l("查看启动数据中心的细节请查看"),a(e,{href:"https://www.consul.io/docs/guides/bootstrapping.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("这里")]),_:1}),l(".")]),s("h2",O,[l("启动 Consul Server "),a(e,{class:"header-anchor",href:"#启动-consul-server","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),V,H,F,U,G,M,s("h2",W,[l("启动 Consul Client "),a(e,{class:"header-anchor",href:"#启动-consul-client","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),K,q,$,Q,J,z,X,s("h2",B,[l("停止Agent "),a(e,{class:"header-anchor",href:"#停止agent","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Y,Z,s("p",null,[l("此外,如果一个agent作为一个服务器,一个优雅的离开是很重要的,可以避免引起潜在的可用性故障影响达成"),a(e,{href:"https://www.consul.io/docs/internals/consensus.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("一致性协议")]),_:1}),l(".")]),s("p",null,[l("查看"),a(e,{href:"https://www.consul.io/docs/internals/consensus.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("这里")]),_:1}),l("了解添加和移除server.")]),s("h2",ss,[l("更新服务 "),a(e,{class:"header-anchor",href:"#更新服务","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),ls,ns,es,as,os,ts,cs,is,rs,ps,Cs,As,s("p",null,[l("HTTP API注册服务,curl命令或者postman 以"),ds,l("方式请求consul HTTP API更多细节"),a(e,{href:"https://www.consul.io/docs/agent/http/catalog.html#catalog_register",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("点击查看")]),_:1})]),us,s("h2",ys,[l("查询服务 "),a(e,{class:"header-anchor",href:"#查询服务","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),hs,Ds,gs,_s,vs,ms,fs,ks,bs,ws,Ts,xs,Is,s("h2",Ss,[l("WEB管理界面 "),a(e,{class:"header-anchor",href:"#web管理界面","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),s("p",null,[l("Consul同时提供了一个漂亮的功能齐全的WEB界面,开箱即用.界面可以用来查看所有的节点,可以查看健康检查和他们的当前状态.可以读取和设置K/V 存储的数据.UI自动支持多数据中心."),a(e,{href:"https://www.consul.io/downloads.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("点击前往下载")]),_:1})]),Ns,Ps,Es,s("ul",null,[Rs,s("li",null,[js,l("：consul服务侦听地址，这个地址提供HTTP、DNS、RPC等服务，默认是127.0.0.1所以不对外提供服务，如果你要对外提供服务改成0.0.0.0 可通过"),a(e,{href:"http://10.201.102.198:8500/",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("http://10.201.102.198:8500")]),_:1}),l("访问WEB管理界面。")])]),Ls,s("h2",Os,[l("健康检查 "),a(e,{class:"header-anchor",href:"#健康检查","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Vs,Hs,Fs,Us,Gs,Ms,Ws,Ks,qs,s("h2",$s,[l("检查健康状态 "),a(e,{class:"header-anchor",href:"#检查健康状态","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Qs,Js,zs,Xs,Bs,s("h2",Ys,[l("K ／V "),a(e,{class:"header-anchor",href:"#k-／v","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Zs,sl,ll,nl,el,al,ol,tl,cl,il,rl,pl,Cl,Al,dl,ul,yl,s("h1",hl,[l("Conusl 命令行 "),a(e,{class:"header-anchor",href:"#conusl-命令行","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Dl,gl,s("p",null,[l("更详细见"),a(e,{href:"https://www.consul.io/docs/commands/index.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("官网")]),_:1})]),s("h2",_l,[l("Agent "),a(e,{class:"header-anchor",href:"#agent","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),vl,ml,s("h2",fl,[l("event "),a(e,{class:"header-anchor",href:"#event","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),kl,bl,s("h2",wl,[l("exec "),a(e,{class:"header-anchor",href:"#exec","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Tl,xl,s("h2",Il,[l("force-leave "),a(e,{class:"header-anchor",href:"#force-leave","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Sl,Nl,s("h2",Pl,[l("info "),a(e,{class:"header-anchor",href:"#info","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),El,Rl,s("h2",jl,[l("join "),a(e,{class:"header-anchor",href:"#join","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Ll,Ol,s("h2",Vl,[l("keygen "),a(e,{class:"header-anchor",href:"#keygen","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Hl,Fl,s("h2",Ul,[l("leave "),a(e,{class:"header-anchor",href:"#leave","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Gl,Ml,s("h2",Wl,[l("members "),a(e,{class:"header-anchor",href:"#members","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Kl,ql,s("h2",$l,[l("monitor "),a(e,{class:"header-anchor",href:"#monitor","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Ql,Jl,s("h2",zl,[l("reload "),a(e,{class:"header-anchor",href:"#reload","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Xl,Bl,s("h2",Yl,[l("version "),a(e,{class:"header-anchor",href:"#version","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Zl,s("h2",sn,[l("watch "),a(e,{class:"header-anchor",href:"#watch","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),ln,nn,s("h1",en,[l("Consul 配置 "),a(e,{class:"header-anchor",href:"#consul-配置","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),an,on,tn,cn,rn,pn,Cn,s("h1",An,[l("HTTP API "),a(e,{class:"header-anchor",href:"#http-api","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),dn,un,yn,s("h2",hn,[l("agent "),a(e,{class:"header-anchor",href:"#agent-1","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Dn,gn,s("h2",_n,[l("catalog "),a(e,{class:"header-anchor",href:"#catalog","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),vn,mn,s("h2",fn,[l("health "),a(e,{class:"header-anchor",href:"#health","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),kn,bn,s("h2",wn,[l("session "),a(e,{class:"header-anchor",href:"#session","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Tn,xn,s("h2",In,[l("acl "),a(e,{class:"header-anchor",href:"#acl","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Sn,Nn,s("h2",Pn,[l("event "),a(e,{class:"header-anchor",href:"#event-1","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),En,Rn,s("h2",jn,[l("status "),a(e,{class:"header-anchor",href:"#status","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Ln,On,s("h1",Vn,[l("Consul-Template "),a(e,{class:"header-anchor",href:"#consul-template","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Hn,Fn,Un,Gn,s("h2",Mn,[l("安装 "),a(e,{class:"header-anchor",href:"#安装","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),s("p",null,[l("你可以在"),a(e,{href:"https://releases.hashicorp.com/consul-template/",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("发布页")]),_:1}),l("下载发布包.如果你希望自己编译请查看"),a(e,{href:"https://github.com/hashicorp/consul-template#contributing",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("说明文档")]),_:1}),l(".")]),s("h2",Wn,[l("使用 "),a(e,{class:"header-anchor",href:"#使用","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Kn,qn,$n,s("h2",Qn,[l("命令行 "),a(e,{class:"header-anchor",href:"#命令行","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Jn,zn,Xn,Bn,Yn,Zn,se,le,ne,ee,ae,oe,te,ce,ie,re,s("h2",pe,[l("模版语法 "),a(e,{class:"header-anchor",href:"#模版语法","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Ce,Ae,s("h2",de,[l("API 函数 "),a(e,{class:"header-anchor",href:"#api-函数","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),ue,ye,he,De,ge,_e,ve,me,fe,ke,be,we,Te,xe,Ie,Se,Ne,Pe,Ee,Re,je,Le,Oe,Ve,He,Fe,Ue,Ge,Me,We,Ke,qe,$e,Qe,Je,ze,Xe,Be,Ye,Ze,sa,la,na,ea,aa,oa,ta,ca,ia,ra,pa,Ca,Aa,da,ua,ya,ha,Da,ga,_a,va,ma,fa,ka,ba,wa,Ta,xa,Ia,Sa,Na,Pa,Ea,Ra,ja,La,Oa,Va,s("p",null,[a(e,{href:"https://book-consul-guide.vnzmi.com/11_consul_template.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("查看更多")]),_:1})]),s("p",null,[a(e,{href:"https://book-consul-guide.vnzmi.com/11_consul_template.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("项目Github地址")]),_:1})]),s("h2",Ha,[l("Haproxy 实例 "),a(e,{class:"header-anchor",href:"#haproxy-实例","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),Fa,Ua,Ga,Ma,s("p",null,[l("10.201.102.185 看我上篇文章"),a(e,{href:"http://www.liangxiansen.cn/2017/03/06/haproxy/",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("Haproxy")]),_:1}),l("，这是consul集群的VIP，为了避免单独调某一台服务器服务器出现故障后consul-template无法工作。")]),Wa,Ka,qa,$a,Qa,s("h1",Ja,[l("参考资料 "),a(e,{class:"header-anchor",href:"#参考资料","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),s("p",null,[a(e,{href:"https://my.oschina.net/guol/blog/675281",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("https://my.oschina.net/guol/blog/675281")]),_:1}),a(e,{href:"https://www.consul.io/docs/guides/index.html",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("https://www.consul.io/docs/guides/index.html")]),_:1}),a(e,{href:"https://www.gitbook.com/book/vincentmi/consul-guide/details",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("https://www.gitbook.com/book/vincentmi/consul-guide/details")]),_:1})]),s("p",null,[a(e,{href:"https://my.oschina.net/abcfy2/blog/675665",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("https://my.oschina.net/abcfy2/blog/675665")]),_:1})]),s("h1",za,[l("下载 "),a(e,{class:"header-anchor",href:"#下载","aria-hidden":"true"},{default:n(()=>[l("#")]),_:1})]),s("p",null,[a(e,{href:"http://www.liangxiansen.cn/files/consul.pdf",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("点击下载PDF文件")]),_:1})]),s("p",null,[l("原:"),a(e,{href:"http://www.liangxiansen.cn/2017/04/06/consul/",target:"_blank",rel:"noreferrer"},{default:n(()=>[l("http://www.liangxiansen.cn/2017/04/06/consul/")]),_:1})])]),"main-header":n(()=>[t(o.$slots,"main-header")]),"main-header-after":n(()=>[t(o.$slots,"main-header-after")]),"main-nav":n(()=>[t(o.$slots,"main-nav")]),"main-content":n(()=>[t(o.$slots,"main-content")]),"main-content-after":n(()=>[t(o.$slots,"main-content-after")]),"main-nav-before":n(()=>[t(o.$slots,"main-nav-before")]),"main-nav-after":n(()=>[t(o.$slots,"main-nav-after")]),comment:n(()=>[t(o.$slots,"comment")]),footer:n(()=>[t(o.$slots,"footer")]),aside:n(()=>[t(o.$slots,"aside")]),"aside-custom":n(()=>[t(o.$slots,"aside-custom")]),default:n(()=>[t(o.$slots,"default")]),_:3},8,["frontmatter","data"])}const co=C(h,[["render",Xa]]);export{to as __pageData,co as default};
