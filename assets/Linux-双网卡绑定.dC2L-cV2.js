import{_ as b}from"./ValaxyMain.vue_vue_type_style_index_0_lang.sBTlPyls.js";import"./chunks/@vueuse/motion.BITvz5PP.js";import{e as f,u as g,a as v}from"./chunks/vue-router.BVXKJEUo.js";import{aa as E,ap as o,ag as e,af as n,ae as S,ai as r,P as y,ab as L,a1 as O}from"./framework.GHZxz7jq.js";import"./index.CViAj0zv.js";import"./chunks/dayjs.BldX5ftQ.js";import"./chunks/vue-i18n.C7V8WoQZ.js";import"./chunks/pinia.BfAlK2F6.js";import"./chunks/nprogress.BZwbcB2O.js";/* empty css                    */import"./YunComment.vue_vue_type_style_index_0_lang.C1Su68f4.js";import"./index.C5okkQwF.js";import"./YunPageHeader.vue_vue_type_script_setup_true_lang.fblE3Fel.js";import"./post.BR8m14Zu.js";const $=f("/posts/Linux-双网卡绑定",async s=>JSON.parse('{"title":"Linux 双网卡绑定","description":"","frontmatter":{"title":"Linux 双网卡绑定","categories":"Linux技术","tags":["双网卡"],"date":"2019-10-09 11:21:00"},"headers":[],"relativePath":"pages/posts/Linux-双网卡绑定.md","lastUpdated":null}'),{lazy:(s,a)=>s.name===a.name}),G={__name:"Linux-双网卡绑定",setup(s,{expose:a}){const{data:m}=$(),u=v(),d=g(),i=Object.assign(d.meta.frontmatter||{},m.value?.frontmatter||{});return u.currentRoute.value.data=m.value,O("valaxy:frontmatter",i),globalThis.$frontmatter=i,a({frontmatter:{title:"Linux 双网卡绑定",categories:"Linux技术",tags:["双网卡"],date:"2019-10-09 11:21:00"}}),(t,l)=>{const p=b;return L(),E(p,{frontmatter:y(i)},{"main-content-md":o(()=>[l[0]||(l[0]=n("h1",{id:"linux-双网卡绑定",tabindex:"-1"},[r("Linux 双网卡绑定 "),n("a",{class:"header-anchor",href:"#linux-双网卡绑定","aria-label":'Permalink to "Linux 双网卡绑定"'},"​")],-1)),l[1]||(l[1]=n("p",null,"双网卡绑定这项继续特别适合利用再生产环境7x24小时的网络传输服务，采取双网卡绑定模式不仅可以提高网络传输速度，更重要的是，还可以确保其中一块网卡出现故障时，依然可以正常高效可靠的措施。下面我会使用两种方案来完成网双卡绑定 一种是传统的配置文件修改方案，另一种是最新的命令生成配置文件方案。",-1)),l[2]||(l[2]=n("p",null,[n("strong",null,"主要常用的三种模式")],-1)),l[3]||(l[3]=n("ul",null,[n("li",null,"mode0（平衡负载模式）：平时两块网卡均工作，且自动备援，但需要在与服务器本地网卡相连的交换机设备上进行端口聚合来支持绑定技术。"),n("li",null,"mode1（自动备援模式）：平时只有一块网卡工作，在它故障后自动替换为另外的网卡。"),n("li",null,"mode6（平衡负载模式）：平时两块网卡均工作，且自动备援，无须交换机设备提供辅助支持。(推荐)")],-1)),l[4]||(l[4]=n("p",null,[n("strong",null,"其他模式介绍")],-1)),l[5]||(l[5]=n("pre",null,[n("code",null,`balance-rr (mode=0)       默认, 有高可用 (容错) 和负载均衡的功能,  需要交换机的配置，每块网卡轮询发包 (流量分发比较均衡).
