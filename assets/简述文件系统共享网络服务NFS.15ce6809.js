...
anongid
\u914D\u7F6E all_squash \u4F7F\u7528,\u6307\u5B9A NFS \u7684\u7528\u6237 UID,\u5FC5\u987B\u5B58\u5728\u7CFB\u7EDF
`)],-1),$=n("h2",{id:"_2-3-\u914D\u7F6Enfs\u670D\u52A1\u7AEF",tabindex:"-1"},[t("2.3 \u914D\u7F6ENFS\u670D\u52A1\u7AEF "),n("a",{class:"header-anchor",href:"#_2-3-\u914D\u7F6Enfs\u670D\u52A1\u7AEF","aria-hidden":"true"},"#")],-1),B=n("p",null,"\u5199\u5165\u914D\u7F6E\u6587\u4EF6\uFF1A\u6CE8\u610F\uFF01IP\u5730\u5740\u548C\u540E\u9762\u7684\u5C0F\u62EC\u53F7\u6CA1\u6709\u7A7A\u683C",-1),D=n("pre",null,[n("code",null,`[root@nfs01 ~]# cat > /etc/exports <<EOF /data 172.16.1.0/24(rw,sync,all_squash) EOF
...
123
`)],-1),dn=n("p",null,"\u5199\u5165\u5F00\u673A\u81EA\u52A8\u6302\u8F7D",-1),cn=n("pre",null,[n("code",null,`[root@backup ~]# vim /etc/fstab 
...
tmpfs               98M     0   98M    0% /run/user/0
172.16.1.31:/data   18G  1.9G   17G   11% /data
`)],-1),pn=n("p",null,"\u5378\u8F7D\u547D\u4EE4\uFF1A\u6CE8\u610F!\u5378\u8F7D\u7684\u65F6\u5019\u5982\u679C\u63D0\u793A\u201Dumount.nfs: /nfsdir: device is busy\u201D\u5148\u5207\u6362\u5230\u5176\u4ED6\u76EE\u5F55\u518D\u5378\u8F7D",-1),un=n("pre",null,[n("code",null,`[root@backup ~]# umount /data/
...
`)],-1),Un=n("p",null,"\u67E5\u770Bnfs\u7684\u7AEF\u53E3",-1),$n=n("pre",null,[n("code",null,`[root@nfs01 ~]# rpcinfo -p
...
`)],-1),Bn=n("p",null,"firewall\u9632\u706B\u5899\u914D\u7F6E",-1),Dn=n("pre",null,[n("code",null,`firewall-cmd --add-service=nfs --permanent
...
chroot /sysroot/
`)],-1),st=n("h1",{id:"\u7B2C3\u7AE0-nfs\u5C0F\u7ED3",tabindex:"-1"},[t("\u7B2C3\u7AE0 NFS\u5C0F\u7ED3 "),n("a",{class:"header-anchor",href:"#\u7B2C3\u7AE0-nfs\u5C0F\u7ED3","aria-hidden":"true"},"#")],-1),ot=n("p",null,"NFS \u5B58\u50A8\u4F18\u70B9",-1),et=n("blockquote",null,[n("p",null,"1.NFS \u6587\u4EF6\u7CFB\u7EDF\u7B80\u5355\u6613\u7528\u3001\u65B9\u4FBF\u90E8\u7F72\u3001\u6570\u636E\u53EF\u9760\u3001\u670D\u52A1\u7A33\u5B9A\u3001\u6EE1\u8DB3\u4E2D\u5C0F\u4F01\u4E1A\u9700\u6C42\u3002 2.NFS \u6587\u4EF6\u7CFB\u7EDF\u5185\u5B58\u653E\u7684\u6570\u636E\u90FD\u5728\u6587\u4EF6\u7CFB\u7EDF\u4E4B\u4E0A\uFF0C\u6240\u6709\u6570\u636E\u90FD\u662F\u80FD\u770B\u5F97\u89C1")],-1),lt=n("p",null,"NFS \u5B58\u50A8\u5C40\u9650",-1),at=n("blockquote",null,[n("p",null,"1.\u5B58\u5728\u5355\u70B9\u6545\u969C, \u5982\u679C\u6784\u5EFA\u9AD8\u53EF\u7528\u7EF4\u62A4\u9EBB\u70E6 web->nfs()->backup 2.NFS \u6570\u636E\u660E\u6587, \u5E76\u4E0D\u5BF9\u6570\u636E\u505A\u4EFB\u4F55\u6821\u9A8C\u3002 3.\u5BA2\u6237\u7AEF\u6302\u8F7D NFS \u670D\u52A1\u6CA1\u6709\u5BC6\u7801\u9A8C\u8BC1, \u5B89\u5168\u6027\u4E00\u822C(\u5185\u7F51\u4F7F\u7528)")],-1),rt=n("p",null,"NFS \u5E94\u7528\u5EFA\u8BAE",-1),dt=n("blockquote",null,[n("p",null,"1.\u751F\u4EA7\u573A\u666F\u5E94\u5C06\u9759\u6001\u6570\u636E\u5C3D\u53EF\u80FD\u5F80\u524D\u7AEF\u63A8, \u51CF\u5C11\u540E\u7AEF\u5B58\u50A8\u538B\u529B 2.\u5FC5\u987B\u5C06\u5B58\u50A8\u91CC\u7684\u9759\u6001\u8D44\u6E90\u901A\u8FC7 CDN \u7F13\u5B58 jpg\\png\\mp4\\avi\\css\\js 3.\u5982\u679C\u6CA1\u6709\u7F13\u5B58\u6216\u67B6\u6784\u672C\u8EAB\u5386\u53F2\u9057\u7559\u95EE\u9898\u592A\u5927, \u5728\u591A\u5B58\u50A8\u4E5F\u65E0\u7528")],-1),ct=n("hr",null,null,-1),pt=n("p",null,"[player id='712292593' type='collect' autoplay='true'/]",-1);function it(o,ut,_t,ht,a,ft){const r=d;return i(),p(r,{frontmatter:a.frontmatter,data:a.data},{"main-content-md":s(()=>[h,f,m,g,w,b,k,v,N,S,F,x,M,y,P,C,T,A,R,E,G,q,U,$,B,D,O,j,I,W,z,L,V,J,K,Z,H,Q,X,Y,nn,tn,sn,on,en,ln,an,rn,dn,cn,pn,un,_n,hn,fn,mn,gn,wn,bn,kn,vn,Nn,Sn,Fn,xn,Mn,yn,Pn,Cn,Tn,An,Rn,En,Gn,qn,Un,$n,Bn,Dn,On,jn,In,Wn,zn,Ln,Vn,Jn,Kn,Zn,Hn,Qn,Xn,Yn,nt,tt,st,ot,et,lt,at,rt,dt,ct,pt]),"main-header":s(()=>[e(o.$slots,"main-header")]),"main-header-after":s(()=>[e(o.$slots,"main-header-after")]),"main-nav":s(()=>[e(o.$slots,"main-nav")]),"main-content":s(()=>[e(o.$slots,"main-content")]),"main-content-after":s(()=>[e(o.$slots,"main-content-after")]),"main-nav-before":s(()=>[e(o.$slots,"main-nav-before")]),"main-nav-after":s(()=>[e(o.$slots,"main-nav-after")]),comment:s(()=>[e(o.$slots,"comment")]),footer:s(()=>[e(o.$slots,"footer")]),aside:s(()=>[e(o.$slots,"aside")]),"aside-custom":s(()=>[e(o.$slots,"aside-custom")]),default:s(()=>[e(o.$slots,"default")]),_:3},8,["frontmatter","data"])}const Nt=c(_,[["render",it]]);export{vt as __pageData,Nt as default};
