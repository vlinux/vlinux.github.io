...
import * as shared_star from "@vueuse/shared";

// node_modules/valaxy/node_modules/@vueuse/head/dist/index.mjs
...
function resolveUnrefDeeply(ref2) {
  const root = (0, shared_exports.resolveUnref)(ref2);
  if (!ref2 || !root)
    return root;
